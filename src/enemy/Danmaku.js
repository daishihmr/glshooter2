...
var $spd1 = function(v) { v = v===undefined?0:v; return $.speed("((0.1+$difficulty)*1.6 - $bg*0.05 + $ex*0.2)*1.5 + 0.50 + ("+v+"*0.1)" ); };
var $spd2 = function(v) { v = v===undefined?0:v; return $.speed("((0.1+$difficulty)*1.6 - $bg*0.05 + $ex*0.2)*1.5 + 0.80 + ("+v+"*0.1)" ); };
var $spd3 = function(v) { v = v===undefined?0:v; return $.speed("((0.1+$difficulty)*1.6 - $bg*0.05 + $ex*0.2)*1.5 + 1.10 + ("+v+"*0.1)" ); };
...
/** 自機狙い弾 */
var $fire0 = function(spd) { return $.fire($.direction("-3+$rand*6"), spd || $spd4, RNS) };
var $fire1 = function(spd) { return $.fire($.direction("-3+$rand*6"), spd || $spd4, BNS) };
...
var $nway = function(way, rangeFrom, rangeTo, speed, bullet, offsetX, offsetY, autonomy) {
    return $.action([
        ...
        $.bindVar("way", "Math.max(3, " + way + "+$ex*2)"),
        $.repeat("$way-1", [
...
gls2.Danmaku["basic0-0Expert"] = new bulletml.Root({
    "top": $.action([
        $fire0,
        $.repeat(4, [
            $.fire($.direction(0, "sequence"), $.speed(0.1, "sequence"), RNS),
        ]),
    ]),
});
...
gls2.Danmaku["basic1-0Expert"] = new bulletml.Root({
    "top": $.action([
        $.repeat(999, [
            $interval(40),
            $fire0($spd3),
...
gls2.Danmaku["basic1-1Expert"] = new bulletml.Root({
    "top": $.action([
        $.repeat(999, [
            $interval(20),
            $fire0($spd3),
...
gls2.Danmaku["basic2-0Expert"] = new bulletml.Root({
    "top": $.action([
        $.repeat(999, [
            $interval(50),
            $fire0($spd3),
...
gls2.Danmaku["basic3-0"] = new bulletml.Root({
    "top": $.action([
        ...
        $.repeat(999, [
            ...
            $fire1($spd3),
            $.repeat(2, [
                $.fire($.direction(0, "sequence"), $.speed(0.1, "sequence"), BNS),
            ]),
        ]),
    ]),
});
gls2.Danmaku["basic3-0Expert"] = new bulletml.Root({
    "top": $.action([
        $.wait(5),
        $.repeat(999, [
            $interval(30),
...
gls2.Danmaku["basic3-1"] = new bulletml.Root({
    "top": $.action([
        ...
        $.repeat(999, [
            ...
            $fire1($spd3),
            $.repeat(2, [
                $fire1($.speed(0.1, "sequence")),
            ]),
        ]),
    ]),
});
gls2.Danmaku["basic3-1Expert"] = new bulletml.Root({
    "top": $.action([
        $.wait(20),
        $.repeat(999, [
            $interval(40),
...
gls2.Danmaku["ako-5Expert"] = new bulletml.Root({
    "top": $.action([
        $.repeat(8, [
            $nway(3, -30, 30, $spd4, RNS),
            $interval(2)
        ]),
    ]),
});
...
gls2.Danmaku["komachi-1Expert"] = new bulletml.Root({
    "top0": $.action([
        $.repeat(20, [
            $.fire($.direction(210, "absolute"), $spd1(1), RNS, $.offsetX(-40)),
            $.fire($.direction(60, "sequence"), $spd1(1), RNS, $.offsetX(-40)),
            $.fire($.direction(60, "sequence"), $spd1(1), RNS, $.offsetX(-40)),
            $.fire($.direction(60, "sequence"), $spd1(1), RNS, $.offsetX(-40)),
            $.fire($.direction(60, "sequence"), $spd1(1), RNS, $.offsetX(-40)),
            $.repeat(57, [
...
gls2.Danmaku["komachi-5"] = new bulletml.Root({
    "top0": $.action([
        $.repeat(999, [
            $.fire($.direction(210, "absolute"), $spd1(1), RNL, $.offsetX(-40)),
            $.fire($.direction(120, "sequence"), $spd1(1), RNL, $.offsetX(-40)),
            $.fire($.direction(120, "sequence"), $spd1(1), RNL, $.offsetX(-40)),
            $.repeat(50/3, [
                $interval(2),
                $.fire($.direction(-360/50, "sequence"), $spd1(1), RNL, $.offsetX(-40)),
                $.fire($.direction(    120, "sequence"), $spd1(1), RNL, $.offsetX(-40)),
                $.fire($.direction(    120, "sequence"), $spd1(1), RNL, $.offsetX(-40)),
            ]),
            $interval(60),
...
gls2.Danmaku["nao-1"] = new bulletml.Root({
    "top": $.action([
        $.repeat(999, [
            $interval(30),
            $.fire($.direction(0), $spd6, RNS),
        ]),
    ]),
});
gls2.Danmaku["nao-1Expert"] = new bulletml.Root({
    "top": $.action([
        $.repeat(999, [
            $interval(30),
            $.fire($.direction(-30), $spd6, RNS),
            $.fire($.direction(0), $spd6, RNS),
            $.fire($.direction(+30), $spd6, RNS),
        ]),
    ]),
...
gls2.Danmaku["nao-2"] = new bulletml.Root({
    "top": $.action([
        $.repeat(999, [
            $interval(30),
             $nway(2, -5, 5, $spd4, RNS, $.offsetX(0), $.offsetY(0), $.autonomy(true)),
        ]),
    ]),
});
gls2.Danmaku["nao-3"] = new bulletml.Root({
    "top": $.action([
        $.repeat(999, [
            $interval(30),
             $nway(2, -1, 1, $spd4, RNS, $.offsetX(0), $.offsetY(0), $.autonomy(true)),
        ]),
    ]),
});
...
gls2.Danmaku["aguriExpert"] = new bulletml.Root({
    "top0": $.action([
        $.repeat(999, [
            $.repeat(3, [
                $whip($spd3, 0.001, 4, function(spd) {
                    return $.action([
                        //左側
                        $nway(3, -60, 60, spd, BL, $.offsetX( -32), $.offsetY(-20)),
                        $nway(2, -60, 60, spd, BL, $.offsetX(-120), $.offsetY( 10)),
                        $nway(2, -60, 60, spd, BL, $.offsetX( -80), $.offsetY( 12)),
                        //右側
                        $nway(3, -60, 60, spd, BL, $.offsetX(  32), $.offsetY(-20)),
                        $nway(2, -60, 60, spd, BL, $.offsetX( 120), $.offsetY( 10)),
                        $nway(2, -60, 60, spd, BL, $.offsetX(  80), $.offsetY( 12)),
    ...
    "top1": $.action([
        $.repeat(999, [
            $.repeat(3, [
                //真ん中
                $nway(3,-30, 30, $spd4, RS, $.offsetX(  0), $.offsetY(  0)),
                $nway(3,-30, 30, $spd4, RS, $.offsetX(  0), $.offsetY( 30)),
                //右側
                $nway(3,-30, 30, $spd4, RS, $.offsetX(-10), $.offsetY(-10)),
                $nway(3,-30, 30, $spd4, RS, $.offsetX(-20), $.offsetY(  0)),
                $nway(3,-30, 30, $spd4, RS, $.offsetX(-20), $.offsetY( 10)),
                $nway(3,-30, 30, $spd4, RS, $.offsetX(-10), $.offsetY( 20)),
                //左側
                $nway(3,-30, 30, $spd4, RS, $.offsetX( 10), $.offsetY(-10)),
                $nway(3,-30, 30, $spd4, RS, $.offsetX( 20), $.offsetY(  0)),
                $nway(3,-30, 30, $spd4, RS, $.offsetX( 20), $.offsetY( 10)),
...
gls2.Danmaku["aliceLeaf-1Expert"] = new bulletml.Root({
    "top0": $.action([
        $.repeat(999, [
            $.repeat(1, [
                //真ん中
                $nway(3,-20, 20, $spd4, RS, $.offsetX(  0), $.offsetY(  0)),
                //右上
                $nway(3,-20, 20, $spd4, BS, $.offsetX( 10), $.offsetY(-10)),
                $nway(3,-20, 20, $spd4, BS, $.offsetX( 10), $.offsetY(-20)),
                $nway(3,-20, 20, $spd4, BS, $.offsetX( 20), $.offsetY(-10)),
                //右下
                $nway(3,-20, 20, $spd4, BS, $.offsetX( 10), $.offsetY( 10)),
                $nway(3,-20, 20, $spd4, BS, $.offsetX( 10), $.offsetY( 20)),
                $nway(3,-20, 20, $spd4, BS, $.offsetX( 20), $.offsetY( 10)),
...
gls2.Danmaku["aliceLeaf-2Expert"] = new bulletml.Root({
    "top0": $.action([
        $.wait(30),
        $.repeat(999, [
            $.repeat(1, [
                //真ん中
                $nway(3,-15, 15, $spd4, BS, $.offsetX(  0), $.offsetY(  0)),
                //右上
                $nway(3,-15, 15, $spd4, RS, $.offsetX( 10), $.offsetY(-10)),
                $nway(3,-15, 15, $spd4, RS, $.offsetX( 10), $.offsetY(-20)),
                $nway(3,-15, 15, $spd4, RS, $.offsetX( 20), $.offsetY(-10)),
...
gls2.Danmaku["honoka-1Expert"] = new bulletml.Root({
    "top0": $.action([
        $.wait(60),
        $.repeat(10, [
            $nway(4, -40, 40, $spd2, RI, $.offsetX(0), $.offsetY(30)),
    ...
    "top1": $.action([
        ...
        $.repeat(5, [
            ...
            $nway(2, -2 - 15, 2 - 15, $spd2(0.6), RNS),
            $nway(3, -3 - 15, 3 - 15, $spd2(1.0), RNS),
            $nway(4, -4 - 15, 4 - 15, $spd2(1.4), RNS),
            $nway(5, -5 - 15, 5 - 15, $spd2(1.8), RNS),
...
gls2.Danmaku["saki-3-1"] = new bulletml.Root({
    "top": $.action([
        $.fire($.direction(180, "absolute"), $spd1, BL($.actionRef("seed0")), $.offsetX(-100)),
        $.fire($.direction(180, "absolute"), $spd1, BL($.actionRef("seed1")), $.offsetX(+100)),
        $interval(120),
    ]),
    "seed0": $.action([
        $.fire($.direction(20, "absolute"), $spd1(0.1), BNS),
        $.repeat(999, [
            $.fire($.direction(360/5, "sequence"), $spd1(0.1), BNS),
            $.fire($.direction(360/5, "sequence"), $spd1(0.1), BNS),
            $.fire($.direction(360/5, "sequence"), $spd1(0.1), BNS),
            $.fire($.direction(360/5, "sequence"), $spd1(0.1), BNS),
            $interval(10),
            $.fire($.direction(360/5+20, "sequence"), $spd1(0.1), BNS),
        ]),
    ]),
    "seed1": $.action([
        $.fire($.direction(-20, "absolute"), $spd1(0.1), BNS),
...
gls2.Danmaku["saki-3-2"] = new bulletml.Root({
    "top": $.action([
        $.fire($.direction(180, "absolute"), $spd1, RL($.actionRef("seed1")), $.offsetX(-120)),
        $.fire($.direction(180, "absolute"), $spd1, RL($.actionRef("seed0")), $.offsetX(+120)),
        $interval(120),
    ]),
    "seed0": $.action([
        $.fire($.direction(20, "absolute"), $spd1(0.1), RNS),
        $.repeat(999, [
            $.fire($.direction(360/5, "sequence"), $spd1(0.1), RNS),
            $.fire($.direction(360/5, "sequence"), $spd1(0.1), RNS),
            $.fire($.direction(360/5, "sequence"), $spd1(0.1), RNS),
            $.fire($.direction(360/5, "sequence"), $spd1(0.1), RNS),
            $interval(10),
            $.fire($.direction(360/5+20, "sequence"), $spd1(0.1), RNS),
        ]),
    ]),
    "seed1": $.action([
        $.fire($.direction(-20, "absolute"), $spd1(0.1), RNS),
...
gls2.Danmaku["rikka-1"] = new bulletml.Root({
    "top": $.action([
        $.repeat(5, [
            ...
            $interval(30),
            $nway(33, (-180+180/33/2)+0, (180-180/33/2)+0, BNL, $spd3("$s"), $.offsetX(-90), $.offsetY(-20)),
            $nway(33, (-180+180/33/2)+0, (180-180/33/2)+0, BNL, $spd3("$s"), $.offsetX(+90), $.offsetY(-20)),
            $interval(3),
            $nway(33, (-180+180/33/2)-1, (180-180/33/2)-1, BNL, $spd3("$s"), $.offsetX(-90), $.offsetY(-20)),
            $nway(33, (-180+180/33/2)+1, (180-180/33/2)+1, BNL, $spd3("$s"), $.offsetX(-90), $.offsetY(-20)),
            $nway(33, (-180+180/33/2)-1, (180-180/33/2)-1, BNL, $spd3("$s"), $.offsetX(+90), $.offsetY(-20)),
            $nway(33, (-180+180/33/2)+1, (180-180/33/2)+1, BNL, $spd3("$s"), $.offsetX(+90), $.offsetY(-20)),
            $interval(3),
    ...
    "top2": $.action([
        ...
        $.repeat(7, [
            ...
            $.repeat(5, [
                ...
                $nway(25, -180+360/25/2, 180-360/25/2, $spd4("$ss"), RNL, $.offsetX(-30), $.offsetY(-30)),
            ]),
            $interval(5),
            $.repeat(5, [
                $.bindVar("ss", "($s-$loop.index)*0.5"),
            ...
            $.repeat(5, [
                $.bindVar("ss", "($s-$loop.index)*0.5"),
                $absoluteNway(26, -180+360/26/2, 180-360/26/2, $spd5("$ss"), BNL, $.offsetX(+30), $.offsetY(-30)),
            ]),
            $interval(5),
            $.repeat(5, [
                $.bindVar("ss", "($s-$loop.index)*0.5"),
...
gls2.Danmaku["mana-1-3"] = new bulletml.Root({
    ...
    "fire": $.action([
        $.repeat(8, [
            $nway(36, -180+180/36, +180-180/36, $spd2, BNL, $.offsetX("$1"), $.offsetY(-50)),
            $interval(50),
        ]),
    ]),
    "dmy": $.action([
...
gls2.Danmaku["mana-2-3"] = new bulletml.Root({
    "top0": $.action([
        $.repeat(30, [
            ...
            $.fire($.direction(180, "absolute"), $.speed(3), BR($.actionRef("child", "$ptn")), $.offsetX(-185), $.offsetY(-50)),
            $.fire($.direction(180, "absolute"), $.speed(3), BR($.actionRef("child", "$ptn")), $.offsetX(+185), $.offsetY(-50)),
            $interval(20)
        ]),
    ]),
...
gls2.Danmaku["fireback"] = new bulletml.Root({
    "top": $.action([
        ...
        $.fire($.direction(0, "sequence"),     $.speed(1.17), FB),
        $.fire($.direction(0, "sequence"),     $.speed(1.14), FB),
        $.fire($.direction(0, "sequence"),     $.speed(1.11), FB),
        $.fire($.direction(0, "sequence"),     $.speed(1.08), FB),
    ]),
});
