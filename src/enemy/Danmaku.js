...
gls2.Danmaku["kanade"] = new bulletml.Root({
    "top0": $.action([
        $.repeat(999, [
            $absoluteNway(50, -180+180/50, +180-180/50, $spd2, RL, $.offsetY(-350)),
            $interval(42),
            $absoluteNway(50, -180+180/50+360/50/2, +180-180/50+360/50/2, $spd2, RL, $.offsetY(-350)),
            $interval(42),
        ]),
    ]),
    "top1": $.action([
        $.repeat(999, [
            $nway(5, -12  +0, +12  +0, $spd3, BL, $.offsetY(-350)),
            $nway(5, -12 +90, +12 +90, $spd3, BL, $.offsetY(-350)),
            $nway(5, -12+180, +12+180, $spd3, BL, $.offsetY(-350)),
            $nway(5, -12+270, +12+270, $spd3, BL, $.offsetY(-350)),
            $interval(57),
        ]),
    ]),
    "top2": $.action([
...
gls2.Danmaku["love-1-1"] = new bulletml.Root({
    ...
    "top1": $.action([
        ...
        $.fire($.direction(-10), IVS, $.offsetX(0), $.offsetY(0)),
        $.repeat(60, [
            $.fire($.direction(+20, "sequence"), $spd2("$loop.index*0.3"), BNL, $.offsetX(-95), $.offsetY(0)),
            $interval(2),
        ]),
    ]),
    "top2": $.action([
...
gls2.Danmaku["love-1-2"] = new bulletml.Root({
    "top0": $.action([
        $interval(40),
        $.repeat(60, [
            $.bindVar("c", "$loop.index"),
            $nway(2, '-60+$c', '60-$c', $spd4(10), BNS, $.offsetX(0), $.offsetY(0)),
            $interval(5),
        ]),
        $interval(40),
    ]),
