...
gls2.Danmaku["mana-2-2"] = new bulletml.Root({
    ...
    "top2": $.action([
        $.fire($.direction(+10), $spd6(3), RNSH, $.offsetX(-145), $.offsetY(-50)),
        $.repeat(100, [
    ...
    "top3": $.action([
        $.fire($.direction(-10), $spd6(3), BNSH, $.offsetX(+145), $.offsetY(-50)),
        $.repeat(100, [
 ...
 * 響第１形態-2
 */
gls2.Danmaku["hibiki-1-2"] = gls2.Danmaku["hibiki-1-1"];
/**
 * 響第１形態-3
 */
gls2.Danmaku["hibiki-1-3"] = gls2.Danmaku["hibiki-1-1"];
/**
 * 響第２形態-1
 */
gls2.Danmaku["hibiki-2-1"] = gls2.Danmaku["hibiki-1-1"];
/**
 * 響第２形態-2
 */
gls2.Danmaku["hibiki-2-2"] = gls2.Danmaku["hibiki-1-1"];
/**
 * 響第２形態-3
 */
gls2.Danmaku["hibiki-2-3"] = gls2.Danmaku["hibiki-1-1"];
/**
 * 響発狂-1
 */
gls2.Danmaku["hibiki-3-1"] = gls2.Danmaku["hibiki-1-1"];
/**
 * 響発狂-2
 */
    ...
    "top0": $.action([
        ...
        $.repeat(2, [
            $whip($spd3, 0.02, 10, function(spd) {
                return $.action([
                    $absoluteNway(5, 200, 120, spd, RNSH, $.offsetX( -85), $.offsetY(  0)),
                    $absoluteNway(6, 190, 130, spd, BNSH,  $.offsetX(-170), $.offsetY(+40)),
                    $absoluteNway(5, 260, 210, spd, RNSH, $.offsetX( +85), $.offsetY(  0)),
                    $absoluteNway(6, 270, 220, spd, BNSH,  $.offsetX(+170), $.offsetY(+40)),
                    $.wait(5),
                ]);
            }),
            $interval(120),
    ...
    "top8": $.action([
        ...
        $.repeat(5, [
            $.repeat(5, [
                ...
                $interval(6),
                $.fire($.direction("-($loop.index+1)*15", "absolute"), $.speed(1), RL($.actionRef("seed2")), $.offsetX(-130), $.offsetY(40)),
                $interval(6),
            ]),
            $interval(120),
        ]),
