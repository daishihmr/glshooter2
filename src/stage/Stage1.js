...
/** @lends {gls2.Stage1.prototype} */
{
    ...
    init: function(gameScene) {
        ...
        this.seq.add(  1, "heri1-left");
        this.seq.add( 20, "tankL-top");
        this.seq.add( 20, "tankRD-left");
        this.seq.add( 50, "heri1-right");
        this.seq.add(  1, "heri1-center");
        this.seq.add( 50, "heri1-center");
        this.seq.add( 10, "tankRD-center");
        this.seq.add( 10, "tankRD-left");
        this.seq.add(  1, "heri1-right");
        ...
        this.seq.add(  1, function() {
            this.gameScene.ground.tweener.clear().to({speed:4}, 5000, "easeInOutQuad");
        });
    ...
    setupBackground: function() {
        this.gameScene.ground.background = tm.graphics.LinearGradient(0, 0, 0, SC_H).addColorStopList([
            { offset:0, color:"hsl(230,50%,10%)" },
            { offset:1, color:"hsl(230,50%, 5%)" },
        ]).toStyle();
    },
