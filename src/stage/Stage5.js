...
/** @lends {gls2.Stage5.prototype} */
{
    ...
    init: function(gameScene) {
        ...
        this.seq.add(260, "urara5-7");
        this.seq.add(260, "urara5-6");
        ...
        this.seq.add(300, "urara5-0");
        this.seq.add(300, "urara5-7");
        this.seq.add(260, "urara5-6");
        ...
        this.seq.add(540, function() {});

        this.seq.add(60, function() {
            this.alartWarning(function() {
                gls2.playBgm("bgmLastBoss", true);
            });
        });
