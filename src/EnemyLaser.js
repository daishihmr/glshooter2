...
/** @lends {gls2.EnemyLaser.prototype} */
{
    ...
    init: function(enemy) {
        ...
        this.baseWidth = this.baseAttackPower*50;
        ...
        this.setColor(["red", "green", "blue"][this.enemy.type]);
        this.setLevel(0);
    },
            ...
            this.origParticle = gls2.Particle(size, 1.0, 0.9, tm.graphics.Canvas()
                ...
                .setFillStyle(
                    tm.graphics.RadialGradient(size*0.5, size*0.5, 0, size*0.5, size*0.5, size*0.5)
                        .addColorStopList([
                            {offset:0.0, color: "rgba(255,255,255,1.0)"},
                            {offset:1.0, color: ["rgba(255,0,0,0.0)","rgba(0,255,0,0.0)","rgba(0,0,255,0.0)"][this.enemy.type]},
                        ]).toStyle()
                )
                .fillRect(0, 0, size, size)
                .element
    ...
    update: function(app) {
        this.visible = this.enemy.fireLaser;
