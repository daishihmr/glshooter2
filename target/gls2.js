...
gls2.lj = tm.createClass({superClass:tm.display.CanvasApp, ye:0, uk:0, wk:0, vk:0, sk:0, tk:l, pe:3, Dd:3, ki:1, ba:l, init:function(c) {
  ...
  var f = this.ba.sf.slice(0, this.ba.Aa + 1).average(), f = {score:Math.floor(this.ba.score), stage:this.ba.Aa + 1, continueCount:this.ba.Pc, shipType:this.ba.da.type, shipStyle:this.ba.da.style, fps:f, screenShot:this.ba.be};
...
gls2.ab = tm.createClass({superClass:gls2.Scene, da:l, score:0, Pc:0, pb:0, Sa:0, Ce:0, hb:0, Zc:0, Aa:0, Ka:l, ja:l, kd:3, Jf:0, Kf:0, Fc:0, of:0, De:0, Ef:0, sd:t, Pb:0, vd:0, $h:0, Ad:t, zf:t, Ec:0, Jb:0, La:t, Ae:0, Wd:0, Xa:0, Qc:0, wl:0, vl:0, vf:l, ni:l, hh:l, Ng:l, Lg:l, Mg:l, Fg:l, xi:l, bc:l, Rb:l, wd:l, ue:t, Bk:t, be:l, gd:l, sf:l, Df:l, lf:l, ff:l, Qd:l, wf:l, vi:l, sh:0, qh:0, th:0, rh:0, ae:0, Cd:0, cd:0, ef:0, init:function() {
  ...
  if(1 === this.We) {
    ...
    if(2 === this.We && localStorage.getItem("recCount") !== i) {
      this.Be = [];
  ...
  if(1 === this.We) {
    1E3 < this.Ke.length && (localStorage.setItem("rec" + this.Le, this.Ke), localStorage.setItem("recCount", this.Le), this.Ke = [], this.Le += 1), this.Ke.push("" + ~~c.getKey("up") + ~~c.getKey("down") + ~~c.getKey("left") + ~~c.getKey("right") + ~~c.getKey("z") + ~~c.getKey("x") + ~~c.getKey("c"))
  }else {
