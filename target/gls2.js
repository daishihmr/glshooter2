...
(function() {
  ...
  I.vf.prototype = new I.jb;
  I.Qf = function(a, b) {
    this.Gb = "notify";
    this.Bj = a;
    this.gb = b || l
  };
  I.Qf.prototype = new I.jb;
  I.Hi = new I.jb;
  I.Fc = function(a) {
    this.type = "aim";
    this.value = a || 0
  ...
  if(this.tb !== l) {
    ...
    if(b !== i) {
      if(b instanceof I.Rb) {
        return this.Zd(), this.tb = b, this.Ca = this.ag(), this.next()
      }
      if(b instanceof I.xd) {
        return this.Zd(), this.tb = this.vh.Fj(b.label), this.Ca = this.cg(b.gb), this.next()
      }
      if(b instanceof I.Ie) {
        return this.Ca.Md = 0, this.Ca.ci = this.eb(b.ti) | 0, this.Zd(), this.tb = b.action.clone(), this.Ca = this.ag(), this.next()
      }
      ...
      return b instanceof I.Af ? (this.Zd(), this.tb = new I.Rb, this.tb.jc = [this.vh.Jj(b.label)], this.Ca = this.cg(b.gb), this.next()) : b instanceof I.Ee ? (a = new I.Ee, a.direction.type = b.direction.type, a.direction.value = this.eb(b.direction.value), a.Cb = this.eb(b.Cb), a) : b instanceof I.Fe ? (a = new I.Fe, a.speed.type = b.speed.type, a.speed.value = this.eb(b.speed.value), a.Cb = this.eb(b.Cb), a) : b instanceof I.Be ? (a = new I.Be, a.Bc.type = b.Bc.type, a.Bc.value = this.eb(b.Bc.value), 
      a.Ec.type = b.Ec.type, a.Ec.value = this.eb(b.Ec.value), a.Cb = this.eb(b.Cb), a) : b instanceof I.Ke ? new I.Ke(this.eb(b.value)) : b instanceof I.Zf ? b : b instanceof I.vf ? (this.Ca["$" + b.Hk] = this.eb(b.Ej), I.Hi) : b instanceof I.Qf ? b : l
    }
    this.nj();
    if(this.tb === l) {
      return l
    }
    if((b = this.tb.jc[this.Sc]) && "repeat" == b.Gb) {
      this.Ca.Md++, this.Ca.Md < this.Ca.ci && (this.Zd(), this.tb = b.action.clone(), this.Ca = this.ag())
    }
    return this.next()
  }
  return l
...
I.Ra.prototype.Zd = function() {
  this.Le.push({action:this.tb, cursor:this.Sc, scope:this.Ca});
  this.Sc = -1
};
I.Ra.prototype.nj = function() {
  var b = this.Le.pop();
  b ? (this.Sc = b.cursor, this.tb = b.action, this.Ca = b.scope) : (this.Sc = -1, this.tb = l, this.Ca = {})
};
I.Ra.prototype.eb = function(b) {
  ...
  a.$rand = Math.random();
  (f = this.Le[this.Le.length - 1]) && (a.$loop = {index:f.scope.Md, count:f.scope.Md + 1, first:0 === f.scope.Md, last:f.scope.Md + 1 >= f.scope.ci});
  return(new Function("return " + b.split("$").join("this.$"))).apply(a)
};
I.Ra.prototype.cg = function(b) {
  var a = {};
  if(b) {
...
I.Ia.Jk = function(b, a, f) {
  ...
  for(d = 0;d < arguments.length;d++) {
    arguments[d] instanceof I.Cf ? h.Bc = b : arguments[d] instanceof I.$f ? h.Ec = a : h.Cb = arguments[d]
  }
...
(function() {
  ...
  tm.Fb.bd = tm.createClass({init:function(a) {
    ...
    if(b === i && 0 < d.length) {
      ...
      for(var p = function() {
        if(!p.stop) {
          ...
          p.ng == f.length && (p.ee = j, this.dispatchEvent(tm.event.Event("completeattack")))
        }
      }, v = f.length;v--;) {
        f[v].mf = p
      }
    ...
    function d() {
      if(!d.stop) {
        ...
        var a = d.Te, b = d.mj;
        if(b) {
          if(d.na < d.lg ? d.direction += d.Id : d.na === d.lg && (d.direction = d.Uc), d.na < d.mg ? d.speed += d.ye : d.na === d.mg && (d.speed = d.Td), d.na < d.fg ? (d.ud += d.Oe, d.wd += d.Pe) : d.na === d.fg && (d.ud = d.Me, d.wd = d.Ne), this.x += Math.cos(d.direction) * d.speed * a.vd, this.y += Math.sin(d.direction) * d.speed * a.vd, this.x += d.ud * a.vd, this.y += d.wd * a.vd, a.wg(this)) {
            if(a.$c || this.$c) {
            ...
            if(!(d.na < d.zi || d.ee)) {
              ...
              d.ee = j;
              d.mf ? d.mf.Dh() : this.dispatchEvent(tm.event.Event("completeattack"))
            }
          }else {
            this.remove(), d.ee = j, d.mf ? d.mf.Dh() : this.dispatchEvent(tm.event.Event("completeattack"))
          }
        }
      }
    }
    ...
    b = b || "top";
    "string" === typeof b ? d.Ai = this.sh.rg(b) : b instanceof I.Ma ? d.Ai = b.rg() : (window.console.error(a, b), g(Error("\u5f15\u6570\u304c\u4e0d\u6b63")));
    d.mj = this;
    d.Te = a;
    d.zi = -1;
    d.ee = s;
    ...
    if(this.nk === i || this.Nb) {
      var v = {label:b.Ha.label}, n;
      for(n in b.Ha.Va) {
        v[n] = b.Ha.Va[n]
      }
      if(v = d.Bh(v)) {
        w = (n = 0 === b.Ha.kb.length) ? w.ij(d) : w.Ue(d, b.Ha);
    ...
    switch(d.direction.type) {
      ...
      case "relative":
        ...
        break;
      case "sequence":
        q.Id = w, q.Uc = q.direction + q.Id * (v - 1)
    }
    q.lg = q.na + v
  }, fj:function(a, b) {
  ...
  tm.Fb.bd.fe = {Bh:tm.Fb.xj, wg:tm.Fb.Gh, dl:0, $c:s, vd:2, target:l};
...
gls2.Li = tm.createClass({superClass:tm.display.CanvasApp, ke:0, Uj:0, Wj:0, Vj:0, Sj:0, Tj:l, ce:3, td:3, Jh:1, ca:l, init:function(b) {
  ...
  if(window.achevements) {
    ...
    if(a[b]) {
      ...
      -1 == f.indexOf(b) && (f.push(b), tm.util.Ajax.load({url:"/api/achevement/" + b, type:"POST", dataType:"json", success:function(d) {
        console.dir(d);
        a[b] && (gls2.ta("achevement"), this.ca.Vh.addChild(gls2.fh(a[b].title)))
      }.bind(this), error:function() {
        console.warn("error!")
      }}))
    }
...
(function() {
  ...
  gls2.oh = tm.createClass({superClass:tm.display.Sprite, type:0, style:0, Ta:0, yc:j, be:j, Nd:s, ca:l, speed:0, Lb:l, Hd:l, fi:l, df:l, Zb:l, sg:l, wc:l, tg:l, ug:l, frame:0, init:function(a, d, h) {
    ...
    this.altitude = 10;
    this.Hd = this.fi = gls2.qh(d, 100);
    this.df = gls2.qh(3, 100);
  ...
  }, Yc:-1, Jd:s, Xb:s, update:function(f) {
    ...
    if(this.yc) {
      ...
      this.Yc = m ? this.Yc + 1 : this.Yc - 1;
      this.Yc = gls2.la.clamp(this.Yc, -1, 10);
      this.Xb = h && m || 10 === this.Yc;
      m = this.ca.Ka ? 3 : 5;
      this.Jd = !this.Xb && (0 <= this.Yc || h) && 0 === f.frame % m;
      h && (this.Yc = 0);
      this.Zb.x = this.x;
      this.Zb.y = this.y - 40;
      d.getKeyDown("x") && this.be && (0 < this.ca.Sa && !this.ca.Ka ? (this.ca.zk(), gls2.bj(this).addChildTo(this.ca)) : !this.ca.qd && 0 < this.ca.Mb && (this.Hb = gls2.la.clamp(this.Hb - 2, 0, 1), this.ca.$d(-0.02), gls2.$g(this, this.ca).setPosition(gls2.la.clamp(this.x, 96, 384), Math.max(this.y - 320, 192)).addChildTo(this.ca), gls2.core.xa("bomb1")))
    }else {
      this.Xb = this.Jd = s
    }
...
(function() {
  var b = l;
  gls2.Dd = tm.createClass({superClass:tm.display.Sprite, speed:0, gd:0, sj:1, Uh:0, nb:j, init:function(a) {
  ...
  var a = gls2.Dd.lb = [];
  gls2.qh = tm.createClass({Xc:l, Th:s, init:function(b, d) {
    this.Th = 3 === b;
    this.Xc = [];
    for(var h = 0;h < d;h++) {
    ...
    for(var b = this.Xc.length;this.Xc[--b] !== i;) {
      this.Xc[b].gd = 1 + 0.1 * a, this.Xc[b].Uh = 0.2 * a
    }
  }})
})();
gls2.kh = tm.createClass({superClass:tm.display.Sprite, fa:l, ca:l, uc:0, frame:0, si:l, color:l, zh:0, hg:0, tj:s, head:l, Ph:l, vc:l, nb:j, gd:1, Pd:l, init:function(b, a) {
  this.fa = b;
  this.ca = b.ca;
  this.zh = 0 === this.fa.style ? 1 : 1.2;
  this.hg = 0 === this.fa.style ? 50 : 75;
  var f = this;
  this.si = a;
  this.superInit(a.redBody, this.hg, 100);
  ...
  this.boundingWidth = this.width = this.hg + 30 * b / 10;
...
gls2.Di = tm.createClass({superClass:tm.display.Sprite, Pc:0, nc:0, fa:l, na:0, init:function(b, a, f) {
...
gls2.Ji = tm.createClass({superClass:tm.display.Sprite, Pc:0, nc:0, fa:l, na:0, init:function(b, a, f) {
  this.superInit("tex3", 64, 64);
...
gls2.zf = tm.createClass({superClass:tm.app.Object2D, target:l, zb:0, angle:0, alpha:2, nb:j, reverse:s, init:function(b, a) {
  this.superInit();
  this.target = b;
  this.reverse = a;
  this.angle = 0;
...
gls2.bj = tm.createClass({superClass:tm.app.Object2D, target:l, angle:0, nb:j, init:function(b) {
  this.superInit();
  this.target = b;
  this.angle = 0
}, update:function() {
...
gls2.Ti = tm.createClass({superClass:tm.graphics.Canvas, ca:l, Gd:l, Bb:l, frame:0, init:function(b) {
  ...
  this.clear();
  this.ca.ic !== l && (this.fillStyle = tm.graphics.LinearGradient(0, 0, 480, 0).addColorStopList([{offset:0, color:"rgba(255,255,0,0.4)"}, {offset:1, color:"rgba(0,255,255,0.4)"}]).toStyle(), this.strokeStyle = "rgba(255,255,255,0.8)", this.lineWidth = 2, this.fillRect(5, this.Bb.Ac - 20, 470 * this.ca.ic.ra / this.ca.ic.Vc, 20), this.strokeRect(5, this.Bb.Ac - 20, 470, 20), this.clear(263.5, this.Bb.Ac - 20 + 2, 2, 16), this.clear(52, this.Bb.Ac - 20 + 2, 2, 16));
  ...
  0 === this.frame % 2 && this.ca.ff && (this.strokeStyle = "rgba(255,255,255,0.5)", this.setText("bold 28px Orbitron", "right", "bottom"), this.strokeText("MAXIMUM", 460, 637));
  this.Gd.update();
...
(function() {
  ...
  gls2.Mi = tm.createClass({superClass:tm.graphics.Canvas, Ea:l, Pb:l, ac:l, init:function() {
  ...
  gls2.Ni = tm.createClass({superClass:tm.app.Object2D, kc:0, lc:0, direction:0, speed:0, Fa:0, Ga:0, background:l, init:function() {
    this.superInit();
    this.kc = [];
    this.lc = [];
    for(var a = 0;5 > a;a++) {
...
gls2.Yf = tm.createClass({superClass:tm.display.Sprite, Xh:s, ca:l, fa:l, Mc:s, pd:s, Tg:s, Fa:0, Ga:0, init:function(b) {
...
gls2.rh = tm.createClass({superClass:gls2.Yf, Mc:s, init:function(b) {
  this.superInit(b)
}, update:function() {
  this.y += 4;
  this.rotation += 10;
...
gls2.aj = tm.createClass({superClass:gls2.Yf, Mc:j, init:function(b) {
  this.superInit(b)
}, update:function() {
...
gls2.$i = tm.createClass({index:0, data:l, Ug:s, init:function() {
  this.data = {}
}, add:function(b, a, f) {
  this.index += b;
...
gls2.Gi = tm.createClass({superClass:gls2.Scene, titleText:l, menu:l, descriptions:l, showExit:s, title:l, selections:[], description:l, box:l, cursor:l, Eg:l, _selected:0, _opened:s, _finished:s, init:function(b, a, f) {
  this.superInit();
  this.titleText = b;
  this.menu = a;
...
;gls2.Ua = tm.createClass({superClass:tm.display.CanvasElement, alpha:1, gg:0.85, size:0, image:l, nb:j, init:function(b, a, f, d) {
  this.superInit();
  ...
  return gls2.Ua(this.size, this.Vk, this.gg, this.image)
}});
...
gls2.Ei = tm.createClass({width:0, label:l, Eb:l, na:0, ki:0, Mg:0, init:function(b) {
  this.width = b;
...
(function() {
  var b = l, a = l;
  gls2.TitleScene = tm.createClass({superClass:gls2.Scene, result:l, na:0, se:[], $e:s, Sh:l, Zh:0, gf:0, init:function() {
    this.superInit();
    ...
    (a.keyboard.getKeyDown("z") || a.keyboard.getKeyDown("c") || a.keyboard.getKeyDown("space")) && !this.$e && this.hi();
    this.na += 1
  }, uh:function(f, d, h) {
    if(!this.$e) {
    ...
    T(this, "SETTING", ["bgm volume", "sound volume"], this.Ig, {defaultValue:this.gf, menuDescriptions:["BGM\u30dc\u30ea\u30e5\u30fc\u30e0\u3092\u8a2d\u5b9a\u3057\u307e\u3059", "\u52b9\u679c\u97f3\u30dc\u30ea\u30e5\u30fc\u30e0\u3092\u8a2d\u5b9a\u3057\u307e\u3059"]})
  }, Ig:function(a) {
    3 !== a && (this.gf = a);
    switch(a) {
      case 0:
...
(function() {
  gls2.Ui = tm.createClass({superClass:gls2.Scene, mode:0, types:l, rf:l, ec:l, fc:l, gc:l, zg:l, xg:l, type:0, style:0, hd:s, kf:s, init:function() {
    this.superInit();
    ...
    if(0 === this.mode) {
      if(this.types.alpha = 1, this.rf.visible = s, !this.kf && a.keyboard.getKeyDown("left")) {
        this.Dg(-1, s), gls2.ta("select")
      }else {
        if(!this.kf && a.keyboard.getKeyDown("right")) {
          this.Dg(1, s), gls2.ta("select")
        }else {
      ...
      1 === this.mode && (this.types.alpha = 0.1, this.rf.visible = j, a.keyboard.getKeyDown("left") ? (this.style = (this.style - 1 + 3) % 3, gls2.ta("select")) : a.keyboard.getKeyDown("right") ? (this.style = (this.style + 1 + 3) % 3, gls2.ta("select")) : a.keyboard.getKeyDown("z") || a.keyboard.getKeyDown("c") || a.keyboard.getKeyDown("space") ? (this.hd = j, this.gi(), gls2.ta("decision")) : a.keyboard.getKeyDown("x") && (this.mode = 0), this.Gk(0 === ~~(a.frame / 60) % 2))
    }
  }, al:function() {
    ...
    b ? (this.ec.hb -= a, this.ec.scaleX = 0 === this.type ? 5 : 1, this.ec.scaleY = 0 === this.type ? 5 : 1, this.fc.hb -= a, this.fc.scaleX = 1 === this.type ? 5 : 1, this.fc.scaleY = 1 === this.type ? 5 : 1, this.gc.hb -= a, this.gc.scaleX = 2 === this.type ? 5 : 1, this.gc.scaleY = 2 === this.type ? 5 : 1) : (this.kf = j, this.ec.tweener.clear().to({hb:this.ec.hb - a, scaleX:0 === this.type ? 5 : 1, scaleY:0 === this.type ? 5 : 1}, 300), this.fc.tweener.clear().to({hb:this.fc.hb - a, scaleX:1 === 
...
gls2.Xa = tm.createClass({superClass:gls2.Scene, fa:l, score:0, Jc:0, mb:0, Oa:0, oe:0, fb:0, Tc:0, Jb:0, ze:l, ka:l, ad:3, of:0, pf:0, Dc:0, We:0, pe:0, jf:0, hd:s, Mb:0, ld:0, Ah:0, qd:s, ff:s, Cc:0, Hb:0, Ka:s, me:0, Kd:0, Sa:0, nd:0, Uk:0, Tk:0, cf:l, Nh:l, Lg:l, Kh:l, pg:l, qg:l, jg:l, Vh:l, $b:l, Qb:l, ic:l, ge:s, ak:s, rj:0, Qd:l, init:function() {
  gls2.Xa.Wd !== l && g(Error("class 'gls2.GameScene' is singleton!!"));
  this.superInit();
  gls2.Xa.Wd = this;
  this.Qb = gls2.Ti(this);
  this.Qb.Bb.addChildTo(this);
  this.ka = gls2.Mi().Ea;
  this.ka.addChildTo(this);
  this.cf = gls2.Xa.Layer().addChildTo(this);
  ...
  this.jg = gls2.Xa.Layer().addChildTo(this);
  this.Vh = gls2.Xa.gh(this).addChildTo(this);
  tm.Fb.bd.fe.xh = this;
  ...
  if(this.fa.Xb) {
    ...
    a = [].concat(gls2.ga.lb);
    for(h = a.length;a[--h] !== i;) {
      m = a[h], !(0 >= m.ra) && gls2.Collision.Ld(m, f) && (m.Kc(q.gd) ? (this.Dc += 1, this.Ka ? this.Db(0.03) : this.Db(0.015), this.Fg(m)) : (this.fb = Math.min(this.fb + 0.02, 1), this.Ka ? (this.Ed(0.01 * S[this.nd]), this.Db(0.0040)) : (this.Ed(0.01), this.Db(0.0020))), q.Lj(2, this.fa.x, this.fa.y - 30))
    }
  }
  if(this.qd) {
    gls2.ha.erase();
    ...
    for(m = h.length;h[--m] !== i;) {
      if(q = h[m], !(0 >= q.ra)) {
        ...
        for(a = f.length;f[--a] !== i;) {
          d = f[a], d.visible !== s && (0 < q.ra && gls2.Collision.Ld(q, d)) && (d.ra -= 6 - this.Hb, 0 > d.ra && (d.Aa(), this.fd(10), this.Ed(1), this.Rh(s, s, d.x, d.y, 1)), q.ra -= 1)
        }
      }
    }
  }
  if(this.ge) {
    ...
    if(this.fa.parent !== l && this.fa.Nd === s && this.qd === s && 0 >= this.me) {
      for(h = gls2.Ma.lb.length;gls2.Ma.lb[--h] !== i;) {
        if(a = gls2.Ma.lb[h], a.visible !== s && gls2.Collision.Ld(a, this.fa)) {
          this.fa.Kc();
          0 < this.Mb && this.hd ? (this.Hb = gls2.la.clamp(this.Hb - 1, 0, 1), this.$d(-0.01), gls2.lh(this.fa, this).setPosition(this.fa.x, this.fa.y).addChildTo(this), gls2.core.xa("bomb2")) : this.di();
          break
        }
      }
    ...
    this.fb -= 0.01;
    0 >= this.fb && (this.fb = 0, this.Ka || 0 < this.Sa ? this.Tc = this.Oa = this.mb = 0 : (0 < this.Oa && (0 >= this.Tc && (this.Tc = 0.0050 * this.Oa), this.mb = this.mb * (this.Oa - this.Tc) / this.Oa, this.Oa -= this.Tc), 0 >= this.Oa && (this.Tc = this.Oa = this.mb = 0)));
  ...
  gls2.ta("star");
  b.Xh ? (this.pf += 1, this.mb += 1E3, this.fd(1E3 + 0 * this.mb), this.Ka ? this.Db(0) : this.Db(0.01)) : (this.of += 1, this.mb += 100, this.fd(100 + 0 * this.mb), this.Ka ? this.Db(0) : this.Db(0.0010))
}, start:function(b, a) {
  this.Qb.Gd.uj().clear();
  ...
  gls2.Dd.de();
  gls2.ha.de();
  this.cf.removeChildren();
  this.pg.removeChildren();
  this.qg.removeChildren();
  this.Lg.removeChildren();
  this.jg.removeChildren();
  this.$b.removeChildren();
  this.Dc = this.We = this.pf = this.of = this.oe = this.fb = this.Oa = this.mb = 0;
  this.ic = l;
  this.ak = this.ge = s;
  this.pe = 0;
  this.Qb.Bb.je = 0;
  ...
  this.fa.remove();
  this.ad -= 1;
  this.Sa = this.Tc = this.Oa = this.fb = 0;
  this.pe += 1;
  this.jf += 1;
  ...
  0 < this.ad ? this.tweener.clear().wait(1E3).call(function() {
    ...
    this.Bg()
  }.bind(this)) : (this.Qd = this.Sg().canvas.toDataURL("image/png"), gls2.core.ke === this.score && (gls2.core.Tj = this.Qd), this.tweener.clear().wait(2E3).call(function() {
  ...
  gls2.core.ke === this.score && (gls2.core.Uj = this.Jb, gls2.core.Wj = this.fa.type, gls2.core.Vj = this.fa.style, gls2.core.Sj = this.Jc);
  ...
  if(10 !== this.Sa) {
    for(b *= 0.75;1 < b;) {
      gls2.zf(this.fa).addChildTo(this), b -= 1, this.Cc = 0, this.Sa += 1, 1 === this.Sa ? (this.yb("HYPER SYSTEM, stand by.", j), gls2.ta("voHyperStandBy")) : (this.yb("HYPER SYSTEM, ready.", j), gls2.ta("voHyperReady"))
    }
    this.Cc = gls2.la.clamp(this.Cc + b, 0, 1);
    1 <= this.Cc && (gls2.zf(this.fa).addChildTo(this), this.Sa += 1, this.Cc -= 1, 1 === this.Sa ? (this.yb("HYPER SYSTEM, stand by.", j), gls2.ta("voHyperStandBy")) : (this.yb("HYPER SYSTEM, ready.", j), gls2.ta("voHyperReady")))
  }
}, zk:function() {
  ...
  this.Kd = 800;
  this.me = 200;
  this.fa.df.Rd(this.Sa);
  this.fa.Zb.Rd(this.Sa);
  this.fa.Hd = this.fa.df;
  ...
  this.Ka !== s && (this.Ka = s, gls2.zf(this.fa, j).addChildTo(this), this.fa.Hd = this.fa.fi, I.Ra.Yb.$hyperOff = 1 * (2 !== this.fa.style ? 1 : 0.5), this.fa.df.Rd(0), this.fa.Zb.Rd(0), this.me = 80, this.nd = this.Kd = 0, gls2.ha.erase())
}, pj:function() {
  gls2.ta("decision");
  gls2.ta("voGetBomb");
  this.Mb = Math.min(this.Mb + 1, this.ld);
  this.ff = this.Mb === this.ld
}, Lh:function() {
  gls2.ta("voExtend");
  this.yb("extended.");
  this.ad += 1
...
}, ve:l, we:0, ne:l, He:0, Ak:function() {
  if(1 === this.He) {
...
gls2.Xa.Wd = l;
gls2.ResultScene = tm.createClass({superClass:gls2.Scene, ca:l, Qd:l, $b:l, values:l, labels:l, ef:l, li:[1E3, 2E3, 4E3, 1E4, 1], Wh:l, Og:l, cursor:0, wait:0, frame:0, init:function(b, a) {
  this.superInit();
  this.ca = b;
  tm.display.Sprite("result_bg", 528, 704).setPosition(240, 320).addChildTo(this);
  this.values = [this.ca.of, this.ca.pf, ~~(100 * (this.ca.Dc / this.ca.We)), this.ca.oe, 0 === this.ca.pe ? 2E7 : 0];
  ...
  for(var d = [], f = 0;12 > f;f++) {
    d[f] = [];
    for(var h = 0;16 > h;h++) {
      d[f][h] = {Pg:0, Oc:0, Pc:gls2.la.randf(-2, 2), nc:gls2.la.randf(1, 4)}
    }
  }
  this.$b = tm.app.Object2D();
  this.$b.draw = function(a) {
    ...
    for(var b = j, f = 0;f < d.length;f++) {
      for(var h = 0;h < d[f].length;h++) {
        var n = d[f][h];
        640 > 40 * h + n.Oc && (a.drawImage(this.Qd.element, 40 * f, 40 * h, 40, 40, 40 * f + n.Pg, 40 * h + n.Oc, 40, 40), n.Pg += n.Pc, n.Oc += n.nc, n.nc += 0.3, b = s)
      }
    }
    this.wait = 60;
    b && this.$b.remove();
  ...
  this.on("enter", function() {
    0 === this.ca.jf && 0 === this.ca.Jc && (0 === this.ca.Jb ? gls2.core.xa("nomiss1") : 1 === this.ca.Jb ? gls2.core.xa("nomiss2") : 2 === this.ca.Jb ? gls2.core.xa("nomiss3") : 3 === this.ca.Jb ? gls2.core.xa("nomiss4") : 4 === this.ca.Jb && gls2.core.xa("nomiss5"))
  });
  ...
  if(!(0 < this.wait)) {
    ...
    if(a < this.values.length) {
      gls2.ta("star"), this.values[a] <= this.ef[a] || b.keyboard.getKeyDown("z") || b.keyboard.getKeyDown("c") || b.keyboard.getKeyDown("space") ? (this.ca.fd(this.values[a] * this.li[a]), this.values[a] = 0, this.cursor += 1, this.wait = 30) : (this.ca.fd(this.ef[a] * this.li[a]), this.values[a] -= this.ef[a]), this.labels[a].text = "" + Math.floor(this.values[a]) + (2 === a ? "%" : ""), this.Wh.text = Math.floor(this.ca.score)
    }else {
      if(this.Og.visible = j, b.keyboard.getKeyDown("z") || b.keyboard.getKeyDown("c") || b.keyboard.getKeyDown("space") || 1800 < this.frame) {
        gls2.ta("decision"), 5 == this.ca.Jb + 1 ? b.replaceScene(gls2.Ii()) : (this.ca.qi(this.ca.Jb + 1), b.replaceScene(this.ca))
      }
    }
    this.frame += 1
  }
}, od:B()});
gls2.eh = tm.createClass({superClass:gls2.Scene, na:0, ii:s, init:function() {
  this.superInit();
  ...
  (b.keyboard.getKeyDown("z") || b.keyboard.getKeyDown("c") || 300 == this.na && !this.ii) && this.lf();
  this.na += 1
}, od:function(b) {
  b.clearColor("black")
}, te:s, wait:s, Qg:l, lf:function() {
  if(!this.wait) {
    this.ii = j;
    var b = ["save score", "tweet result", "back to title"], a = ["\u30b9\u30b3\u30a2\u3092\u30e9\u30f3\u30ad\u30f3\u30b0\u30b5\u30fc\u30d0\u30fc\u3078\u9001\u4fe1\u3057\u307e\u3059", "\u30b9\u30b3\u30a2\u3092Twitter\u3078\u6295\u7a3f\u3057\u307e\u3059", "\u30bf\u30a4\u30c8\u30eb\u3078\u623b\u308a\u307e\u3059"];
    this.te && (b.shift(), a.shift());
    T(this, "GAME OVER", b, this.kk, {defaultValue:this.te ? 1 : 0, menuDescriptions:a, showExit:s})
  }
}, kk:function(b) {
  this.te && (b += 1);
  0 === b ? this.te || (this.wait = j, this.app.Ng(l, function(a, b, d) {
    this.wait = s;
    a ? this.qk(a) : b ? (this.te = j, this.Qg = d, this.rk()) : this.lf()
...
(function() {
  ...
  gls2.Ii = tm.createClass({superClass:gls2.Scene, ka:l, fa:l, labels:l, pi:s, speed:0, Mh:s, ai:l, init:function() {
    ...
    a.keyboard.getKey("z") || a.keyboard.getKey("x") || a.keyboard.getKey("c") || this.pi && gls2.$a && gls2.$a.source.playbackState !== AudioBufferSourceNode.PLAYING_STATE ? this.labels.some(function(a) {
      return!!a.parent
...
(function() {
  gls2.ga = tm.createClass({superClass:tm.display.CanvasElement, name:l, fa:l, ca:l, ze:l, ra:0, Vc:0, score:0, Mc:s, erase:s, star:1, $j:s, Nb:j, Qa:s, frame:0, sf:l, direction:0, speed:0, ia:l, init:function(a, f, d) {
    this.superInit();
    this.addEventListener("added", function() {
      this.frame = 0;
      this.Qa = s;
    ...
    gls2.oa.Xe(this.x, this.y, this.ca, this.sf);
    this.remove()
  }, Ob:function() {
...
gls2.yd = tm.createClass({superClass:gls2.ga, $j:j, Vc:0, nf:l, init:function(b, a, f) {
  this.nf = a;
  this.superInit(b, this.nf[0], f);
  this.Vc = this.ra;
  this.addEventListener("added", function() {
    this.ca.ic = this;
    this.ca.wk();
  ...
  this.ra <= 0.55 * this.Vc && 0.55 * this.Vc < a ? (gls2.da.qf(this), this.clearEventListener("completeattack"), this.tweener.clear(), gls2.oa.ub(this.x, this.y, this.ca), gls2.ha.erase(j, this.ca.Ka), this.nf[1].setup(this)) : this.ra <= 0.1 * this.Vc && 0.1 * this.Vc < a && (gls2.da.qf(this), this.clearEventListener("completeattack"), this.tweener.clear(), gls2.oa.ub(this.x, this.y, this.ca), gls2.ha.erase(j, this.ca.Ka), this.nf[2].setup(this), gls2.ta("voJacms"))
}});
(function() {
  ...
  gls2.ga.ma = tm.createClass({superClass:gls2.ga, dg:l, eg:l, init:function(a, f) {
    ...
    this.dg.setFrameIndex(~~(16 * a / (2 * Math.PI)), 64, 64);
    this.eg.setFrameIndex(~~(16 * b / (2 * Math.PI)) + 16, 64, 64)
  }, draw:function(a) {
    this.dg.draw(a);
    this.eg.draw(a)
  }, Aa:function() {
  ...
  gls2.ga.cb = tm.createClass({superClass:gls2.ga, ea:l, ig:l, init:function(a, f) {
    this.superInit(a, f, "kasugano");
    this.ea = b("tex1", 64, 64).setFrameIndex(23);
    this.vc = gls2.Ua(80, 1, 0.8);
    this.ig = tm.geom.Vector2()
  }, update:function(a) {
    ...
    this.rotation = tm.geom.Vector2.sub(this.position, this.ig).toAngle() * gls2.la.RAD_TO_DEG - 90;
    this.ig.set(this.x, this.y)
  }, Pa:function() {
    this.on("enterframe", function(a) {
      0 === a.app.frame % 30 ? this.ea.bb() : 5 === a.app.frame % 30 && this.ea.ab()
    })
  ...
  gls2.ga.xf = tm.createClass({superClass:gls2.ga, ea:l, init:function(a, f) {
  ...
  gls2.ga.tf = tm.createClass({superClass:gls2.ga, init:function(a, f) {
    ...
    for(var a = 0;4 > a;a++) {
      var b = 0.5 * Math.PI * a;
      this.Nc[a] = this.ze.Cg({aa:gls2.ga.uf, ba:gls2.da.uf, x:this.x + 64 * Math.sin(b), y:this.y + 64 * Math.cos(b)});
      this.Nc[a].dir = b;
      this.Nc[a].og = this;
      this.Nc[a].ck = a;
  ...
  gls2.ga.Bf = tm.createClass({superClass:gls2.ga, ea:l, init:function(a, f) {
  ...
  gls2.ga.Nf = tm.createClass({superClass:gls2.yd, ea:l, init:function(a, f) {
  ...
  gls2.ga.Jf = tm.createClass({superClass:gls2.ga, init:function(a, f) {
  ...
  gls2.ga.Xf = tm.createClass({superClass:gls2.ga, init:function(a, f) {
    ...
    if(a) {
      for(a = 0;3 > a;a++) {
        gls2.oa.bf(this.x + gls2.ua.rand(-100, 100), this.y + gls2.ua.rand(-50, 50), this.ca, 2)
      }
      this.alpha = 0
    }else {
      for(a = 0;3 > a;a++) {
...
(function() {
  ...
  gls2.da.bh = gls2.da.Bi("bukky-4-0");
  ...
  gls2.da.wf = b("cannon2-3", j);
  gls2.da.De = b("cannon3-0", j);
  gls2.da.yf = b("cannon5-0", j);
  var a = tm.createClass({superClass:gls2.da, velocityY:0, La:l, delay:0, init:function(a, b, f) {
    ...
    a.on("enterframe", function() {
      this.mi && (this.y += this.velocityY, 384 < this.y && gls2.da.qf(this), this.Qa && !this.Ob() && this.remove(), this.Nb = this.y < this.fa.y)
    })
  }});
  ...
  gls2.da.pb = tm.createClass({superClass:gls2.da, vi:0, xi:0, wi:0, yi:0, init:function(a, b, f, q) {
    this.superInit();
    this.vi = a;
    this.xi = b;
    this.wi = f;
  ...
  gls2.da.cb = tm.createClass({superClass:gls2.da, ei:0, direction:1, delay:0, init:function(a, b, f) {
    this.superInit();
    this.ei = a;
    this.direction = b;
    this.delay = f
  ...
  gls2.da.Ab = tm.createClass({superClass:gls2.da, Za:l, init:function(a) {
    ...
    a.tweener.wait(gls2.ua.rand(0, 1E3)).call(function() {
      ...
      this.zb = 0;
      this.on("enterframe", function() {
        this.y < this.Ck && (this.Oc += 1);
        this.x += this.speed;
        this.y = this.Oc + 8 * Math.sin(this.zb);
        this.zb += 0.03
      })
    }.bind(a))
  }});
  ...
  gls2.da.Ff = a(0.5, "komachi-4");
  gls2.da.Ef = a(0.5, "komachi-5");
  ...
  gls2.da.Rf = a(0.1, "nozomi-4");
  gls2.da.Sf = a(0.3, "nozomi-5");
  ...
  b = tm.createClass({superClass:gls2.da, ia:l, hf:0, init:function(a, b) {
    this.superInit();
    this.ia = a;
    this.hf = b || 1500
  }, setup:function(a) {
    ...
    a.on("enterframe", function() {
      if(!(this.ib === s || 0 >= this.ra) && this.hf < this.frame && this.Ya === s) {
  ...
  gls2.da.Pf = tm.createClass({superClass:gls2.da, init:function() {
    this.superInit()
  }, setup:function(a) {
    gls2.da.prototype.setup.call(this, a);
    a.tweener.clear().wait(800).call(function() {
  ...
  gls2.da.Tf = b(["rikka-1", "rikka-2", "rikka-3"], 3E3);
...
(function() {
  ...
  "tsubomi-2":[{aa:b.Je, ba:a.De, x:384, y:-100}], "tsubomi-R0":[{aa:b.Je, ba:a.De, x:580, y:128}], "itsuki-0":[{aa:b.Df, ba:a.yf, x:96, y:-100}], "itsuki-1":[{aa:b.Df, ba:a.yf, x:240, y:-100}], "itsuki-2":[{aa:b.Df, ba:a.yf, x:384, y:-100}], "makoto-0":[{aa:b.oc, ba:a.pc, x:48, y:-100}], "makoto-1":[{aa:b.oc, ba:a.pc, x:96, y:-100}], "makoto-2":[{aa:b.oc, ba:a.pc, x:144, y:-100}], "makoto-3":[{aa:b.oc, ba:a.pc, x:192, y:-100}], "makoto-4":[{aa:b.oc, ba:a.pc, x:240, y:-100}], "makoto-5":[{aa:b.oc, 
  ba:a.pc, x:288, y:-100}], "makoto-6":[{aa:b.oc, ba:a.pc, x:336, y:-100}], "makoto-7":[{aa:b.oc, ba:a.pc, x:384, y:-100}], "makoto-8":[{aa:b.oc, ba:a.pc, x:432, y:-100}], "makoto-R0":[{aa:b.oc, ba:a.pc, x:580, y:128}], "karen-3-2":[{aa:b.xf, ba:a.wf, x:96, y:-100}], "karen-3-5":[{aa:b.xf, ba:a.wf, x:240, y:-100}], "karen-3-8":[{aa:b.xf, ba:a.wf, x:384, y:-100}], "fighter-m-0":[{aa:b.Qc, ba:a.cd, x:96, y:-192}], "fighter-m-1":[{aa:b.Qc, ba:a.cd, x:144, y:-192}], "fighter-m-2":[{aa:b.Qc, ba:a.cd, 
  x:192, y:-192}], "fighter-m-3":[{aa:b.Qc, ba:a.cd, x:240, y:-192}], "fighter-m-4":[{aa:b.Qc, ba:a.cd, x:288, y:-192}], "fighter-m-5":[{aa:b.Qc, ba:a.cd, x:336, y:-192}], "fighter-m-6":[{aa:b.Qc, ba:a.cd, x:384, y:-192}], "fighter-m4-0":[{aa:b.Qc, ba:a.Qi, x:96, y:-192}], "tsukikage-r":[{aa:b.Ub, ba:a.ed(700), x:624, y:256}, {aa:b.Ub, ba:a.ed(600), x:720, y:256}, {aa:b.Ub, ba:a.ed(500), x:576, y:320}, {aa:b.Ub, ba:a.ed(400), x:672, y:320}, {aa:b.Ub, ba:a.ed(300), x:768, y:320}, {aa:b.Ub, ba:a.ed(200), 
  ...
  y:-192}], "komachi3-1":[{aa:b.Vb, ba:a.jh, x:336, y:-192}], "komachi4-0":[{aa:b.Vb, ba:a.Ff, x:144, y:-192}], "komachi4-1":[{aa:b.Vb, ba:a.Ff, x:336, y:-192}], "komachi4-2":[{aa:b.Vb, ba:a.Ff, x:240, y:-192}], "komachi5-0":[{aa:b.Vb, ba:a.Ef, x:144, y:-192}], "komachi5-1":[{aa:b.Vb, ba:a.Ef, x:336, y:-192}], "komachi5-2":[{aa:b.Vb, ba:a.Ef, x:240, y:-192}], "nozomi4-0":[{aa:b.Cd, ba:a.Rf, x:144, y:-192}], "nozomi4-1":[{aa:b.Cd, ba:a.Rf, x:240, y:-192}], "nozomi4-2":[{aa:b.Cd, ba:a.Rf, x:336, y:-192}], 
  "nozomi5-0":[{aa:b.Cd, ba:a.Sf, x:144, y:-256}], "nozomi5-1":[{aa:b.Cd, ba:a.Sf, x:240, y:-128}], "nozomi5-2":[{aa:b.Cd, ba:a.Sf, x:336, y:-256}], "mktn5-0":[{aa:b.Vd, ba:a.Vd(0.6), x:624, y:128}], "mktn5-1":[{aa:b.Vd, ba:a.Vd(0.4), x:-144, y:64}], "akane-center":[{aa:b.Ja, ba:a.Ja, x:144, y:130}, {aa:b.Ja, ba:a.Ja, x:192, y:80}, {aa:b.Ja, ba:a.Ja, x:240, y:140}, {aa:b.Ja, ba:a.Ja, x:288, y:80}, {aa:b.Ja, ba:a.Ja, x:336, y:130}], "akane-right":[{aa:b.Ja, ba:a.Ja, x:384, y:160}, {aa:b.Ja, ba:a.Ja, 
  ...
  y:-128}], miyuki_t2:[{aa:b.rd, ba:a.rd, x:144, y:-128}], alice:[{aa:b.tf, ba:a.tf, x:240, y:-64}], erika:[{aa:b.Ud, ba:a.Ud, x:240, y:-100}], yukishiro:[{aa:b.Bf, ba:a.Bf, x:240, y:-100}], misumi:[{aa:b.Nf, ba:[a.Ri, a.Of, a.Pf], x:240, y:-100, ic:j}], mai:[{aa:b.Jf, ba:a.Jf, x:780, y:128}], hyuga:[{aa:b.Si, ba:[a.Uf, a.Vf, a.Wf], x:240, y:-100, ic:j}], higashi:[{aa:b.Xf, ba:a.Xf, x:780, y:128}], momozono:[{aa:b.Oi, ba:[a.Gf, a.Hf, a.If], x:240, y:-100, ic:j}], rikka:[{aa:b.Tf, ba:a.Tf, x:240, 
  y:-100}], mana:[{aa:b.Pi, ba:[a.Kf, a.Lf, a.Mf], x:240, y:-100, ic:j}]}
})();
(function() {
  function b(a, b, d, f) {
  ...
  gls2.Ma.he = function() {
    gls2.Ma.he.kg === l && (gls2.Ma.he.kg = gls2.Ua(10, 1, 0.92, tm.graphics.Canvas().resize(10, 10).setFillStyle(tm.graphics.RadialGradient(5, 5, 0, 5, 5, 5).addColorStopList([{offset:0, color:"rgba(255,100,100,0.0)"}, {offset:0.3, color:"rgba(255,100,100,0.0)"}, {offset:0.9, color:"rgba(255,180,180,1.0)"}, {offset:1, color:"rgba(255,100,100,0.0)"}]).toStyle()).fillRect(0, 0, 10, 10).element));
    return gls2.Ma.he.kg.clone()
  };
  gls2.Ma.he.kg = l;
  var O = [], L = gls2.Ma.lb = []
})();
