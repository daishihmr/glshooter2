...
(function() {
  ...
  G.ka = function(a) {
    ...
    if(a !== i) {
      for(var b in a) {
        a.hasOwnProperty(b) && (a[b].label = b, a[b] instanceof G.Lb ? this.fb.push(a[b]) : a[b] instanceof G.Oa ? this.Ge.push(a[b]) : a[b] instanceof G.nd && this.Oe.push(a[b]))
      }
      a = 0;
  ...
  G.ka.prototype.Ih = function(a) {
    return b(this.fb, a)
  };
  G.ka.prototype.Bk = function() {
  ...
  G.ka.prototype.qk = function(a) {
    return b(this.Ge, a)
  };
  G.ka.prototype.rk = function(a) {
    var b;
    if(b = this.qk(a)) {
      return b
    }
  ...
  G.ka.prototype.sk = function(a) {
    return b(this.Oe, a)
  };
  G.ka.prototype.tk = function(a) {
    var b;
    if(b = this.sk(a)) {
      return b
    }
  ...
  G.pe.prototype.clone = function(a) {
    var b = a.Aa;
    a.Aa = a.Tf(this.ab);
    var f = this.root.rk(this.label).clone(a);
    a.Aa = b;
    return f
  };
  G.pe.prototype.Ub = function(a) {
    this.root = a
  };
  G.eb = function() {
    this.Ab = ""
  ...
  G.ld.prototype = new G.eb;
  G.ld.prototype.clone = function() {
    var a = new G.Lb;
    a.root = this.root;
    a.ac.push(this);
    return a
  ...
  G.nd.prototype = new G.eb;
  G.nd.prototype.Ub = function(a) {
    this.root = a;
  ...
  G.pf.prototype = new G.eb;
  G.re = function() {
    this.Ab = "changeDirection";
    this.direction = new G.uc;
    this.vb = 0
  };
  G.re.prototype = new G.eb;
  G.se = function() {
    this.Ab = "changeSpeed";
    this.speed = new G.yc;
    this.vb = 0
  };
  G.se.prototype = new G.eb;
  G.oe = function() {
    this.Ab = "accel";
    this.pc = new G.tf;
    this.tc = new G.Rf;
  ...
  G.oe.prototype = new G.eb;
  G.ze = function(a) {
    this.Ab = "wait";
    this.value = a || 0
  };
  G.ze.prototype = new G.eb;
  G.Qf = function() {
    this.Ab = "vanish"
  };
  G.Qf.prototype = new G.eb;
  G.xe = function() {
    this.Ab = "repeat";
    this.mi = 0;
    this.action = l;
  ...
  if(this.ob !== l) {
    ...
    if(b !== i) {
      if(b instanceof G.Lb) {
        return this.Nd(), this.ob = b, this.Aa = this.Sf(), this.next()
      }
      if(b instanceof G.ld) {
        return this.Nd(), this.ob = this.sh.pk(b.label), this.Aa = this.Tf(b.ab), this.next()
      }
      if(b instanceof G.xe) {
        return this.Aa.Dd = 0, this.Aa.vg = this.Za(b.mi) | 0, this.Nd(), this.ob = b.action.clone(), this.Aa = this.Sf(), this.next()
      }
      if(b instanceof G.nd) {
        var a = new G.nd;
      ...
      return b instanceof G.pf ? (this.Nd(), this.ob = new G.Lb, this.ob.ac = [this.sh.tk(b.label)], this.Aa = this.Tf(b.ab), this.next()) : b instanceof G.re ? (a = new G.re, a.direction.type = b.direction.type, a.direction.value = this.Za(b.direction.value), a.vb = this.Za(b.vb), a) : b instanceof G.se ? (a = new G.se, a.speed.type = b.speed.type, a.speed.value = this.Za(b.speed.value), a.vb = this.Za(b.vb), a) : b instanceof G.oe ? (a = new G.oe, a.pc.type = b.pc.type, a.pc.value = this.Za(b.pc.value), 
      a.tc.type = b.tc.type, a.tc.value = this.Za(b.tc.value), a.vb = this.Za(b.vb), a) : b instanceof G.ze ? new G.ze(this.Za(b.value)) : b instanceof G.Qf ? b : b instanceof G.kf ? (this.Aa["$" + b.tl] = this.Za(b.ok), G.Hi) : b instanceof G.Hf ? b : l
    }
    this.Zj();
    if(this.ob === l) {
      return l
    ...
    if((b = this.ob.ac[this.Ic]) && "repeat" == b.Ab) {
      this.Aa.Dd++, this.Aa.Dd < this.Aa.vg && (this.Nd(), this.ob = b.action.clone(), this.Aa = this.Sf())
    }
    return this.next()
  }
  return l
};
G.Ra.prototype.Nd = function() {
  this.Ae.push({action:this.ob, cursor:this.Ic, scope:this.Aa});
  this.Ic = -1
};
G.Ra.prototype.Zj = function() {
  var b = this.Ae.pop();
...
G.Ra.prototype.Za = function(b) {
  ...
  a.$rand = Math.random();
  (d = this.Ae[this.Ae.length - 1]) && (a.$loop = {index:d.scope.Dd, count:d.scope.Dd + 1, first:0 === d.scope.Dd, last:d.scope.Dd + 1 >= d.scope.vg});
  return(new Function("return " + b.split("$").join("this.$"))).apply(a)
};
G.Ra.prototype.Tf = function(b) {
  var a = {};
  if(b) {
...
G.Ia = function(b) {
  b = b || "";
  for(var a in G.Ia) {
    G.Ia.hasOwnProperty(a) && (G.Li[b + a] = G.Ia[a])
  }
};
...
G.Ia.fire = function(b, a, d, f) {
  ...
  m = new G.nd;
  for(h = 0;h < arguments.length;h++) {
    arguments[h] instanceof G.uc ? m.direction = arguments[h] : arguments[h] instanceof G.yc ? m.speed = arguments[h] : arguments[h] instanceof G.Oa ? m.Ha = arguments[h] : arguments[h] instanceof G.pe ? m.Ha = arguments[h] : arguments[h] instanceof G.te ? m.Va = arguments[h] : arguments[h] instanceof G.ih ? m.Va.offsetX = arguments[h].value : arguments[h] instanceof G.jh ? m.Va.offsetY = arguments[h].value : arguments[h] instanceof G.Tg && (m.Va.va = arguments[h].value)
  }
  m.Ha === i && g(Error("bullet (or bulletRef) is required."));
  return m
};
G.Ia.Fl = function(b, a) {
  for(var d = 0, f = arguments.length;d < f;d++) {
    arguments[d] instanceof Function && (arguments[d] = arguments[d]())
  }
  b === i && g(Error("label is required."));
...
G.Ia.repeat = function(b, a) {
  ...
  f = new G.xe;
  f.mi = b;
  if(a instanceof G.Lb || a instanceof G.ld) {
    f.action = a
  }else {
    if(a instanceof Array) {
...
(function() {
  ...
  tm.zb.Tc = tm.createClass({init:function(a) {
    ...
    if(b === i && 0 < d.length) {
      ...
      for(var p = function() {
        if(!p.stop) {
          ...
          p.eg == f.length && (p.Sd = j, this.dispatchEvent(tm.event.Event("completeattack")))
        }
      }, w = f.length;w--;) {
        f[w].Ye = p
      }
    ...
    function d() {
      if(!d.stop) {
        ...
        var a = d.Ie, b = d.Yj;
        if(b) {
          if(d.na < d.cg ? d.direction += d.xd : d.na === d.cg && (d.direction = d.Lc), d.na < d.dg ? d.speed += d.me : d.na === d.dg && (d.speed = d.Jd), d.na < d.Wf ? (d.hd += d.De, d.kd += d.Ee) : d.na === d.Wf && (d.hd = d.Be, d.kd = d.Ce), this.x += Math.cos(d.direction) * d.speed * a.jd, this.y += Math.sin(d.direction) * d.speed * a.jd, this.x += d.hd * a.jd, this.y += d.kd * a.jd, a.og(this)) {
            if(a.Rc || this.Rc) {
              this.rotation = (d.direction + 0.5 * Math.PI) * Math.RAD_TO_DEG, this.speed = d.speed
            }
            if(!(d.na < d.ni || d.Sd)) {
              for(var f;f = d.oi.next();) {
                switch(f.Ab) {
                  case "fire":
                    b.Vj.call(this, f, a, d, b);
                    break;
                  case "wait":
                    a = 0;
                    d.ni = "number" === typeof f.value ? d.na + f.value : 0 !== (a = ~~f.value) ? d.na + a : d.na + eval(f.value);
                    return;
                  case "changeDirection":
                    b.Qj.call(this, f, a, d);
                    break;
                  case "changeSpeed":
                    b.Rj.call(this, f, d);
                    break;
              ...
              d.Sd = j;
              d.Ye ? d.Ye.yh() : this.dispatchEvent(tm.event.Event("completeattack"))
            }
          }else {
            this.remove(), d.Sd = j, d.Ye ? d.Ye.yh() : this.dispatchEvent(tm.event.Event("completeattack"))
          }
        }
      }
    }
    a = function(a) {
      var b = {}, d = tm.zb.Tc.Ud, f;
      for(f in d) {
    ...
    b = b || "top";
    "string" === typeof b ? d.oi = this.ph.jg(b) : b instanceof G.Oa ? d.oi = b.jg() : (window.console.error(a, b), g(Error("\u5f15\u6570\u304c\u4e0d\u6b63")));
    d.Yj = this;
    d.Ie = a;
    d.ni = -1;
    d.Sd = r;
    ...
    function b() {
      b.stop || (this.x += b.Ch, this.y += b.Dh, b.Ie.og(this) || this.remove())
    }
    a = function(a) {
      var b = {}, d = tm.zb.Tc.Ud, f;
      for(f in d) {
    ...
    if(this.al === i || this.Gb) {
      var w = {label:b.Ha.label}, n;
      for(n in b.Ha.Va) {
        w[n] = b.Ha.Va[n]
      }
      if(w = d.xh(w)) {
        v = (n = 0 === b.Ha.fb.length) ? v.Uj(d) : v.Je(d, b.Ha);
        ...
        w.x = s.x;
        w.y = s.y;
        n && (v.Ch = Math.cos(v.direction) * v.speed * d.jd, v.Dh = Math.sin(v.direction) * v.speed * d.jd);
        w.Rc = !!w.Rc;
        if(d.Rc || w.Rc) {
          w.rotation = (v.direction + 0.5 * Math.PI) * Math.RAD_TO_DEG, w.speed = v.speed
        }
        w.addEventListener("enterframe", v);
        d.uh ? d.uh.addChild(w) : this.parent && this.parent.addChild(w)
      }
    }
  }, Qj:function(d, f, q) {
    ...
    switch(d.direction.type) {
      ...
      case "relative":
        ...
        break;
      case "sequence":
        q.xd = v, q.Lc = q.direction + q.xd * (w - 1)
    }
    q.cg = q.na + w
  }, Rj:function(a, b) {
    ...
    if(a.tc) {
      switch(f = eval(a.tc.value), a.tc.type) {
        ...
        case "sequence":
          ...
          break;
        case "relative":
          b.Ee = f, b.Ce = (f - b.kd) * d
      }
    }else {
      b.Ee = 0, b.Ce = b.kd
    }
  }, Wj:function(a) {
    var b = tm.event.Event(a.lk);
    if(a.ab) {
      for(var d in a.ab) {
        b[d] = a.ab[d]
      }
  ...
  tm.zb.Tc.Ud = {xh:tm.zb.hk, og:tm.zb.Bh, Pl:0, Rc:r, jd:2, target:l};
  G.ka.prototype.Je = function(a) {
    return tm.zb.Tc(this).Je(a)
  }
})();
/*
 gls2.js v1.0-beta
...
gls2.pause = function() {
  gls2.core && gls2.core.currentScene === gls2.Wa.Ld && gls2.Wa.Ld.ge(0)
};
gls2.Ni = tm.createClass({superClass:tm.display.CanvasApp, Ad:0, Oh:0, Qh:0, Ph:0, Mh:0, Dk:l, Qd:3, gd:3, Eh:1, da:l, init:function(b) {
  ...
  for(var b = [].concat(this.Qg), a = 0;a < b.length;a++) {
    b[a].frame === this.frame ? b[a].fn() : this.Qg.erase(b[a])
  }
}, draw:function() {
  ...
  this.stop()
}, Yh:r, Ig:function(b, a) {
  var d = {score:Math.floor(this.da.score), stage:this.da.af + 1, continueCount:this.da.Td, shipType:this.da.ea.type, shipStyle:this.da.ea.style, fps:0, screenShot:this.da.Gd};
  b ? (d.userName = b, this.Yh = r) : this.Yh = j;
        ...
        if(b.confirmLogin) {
          if(confirm("\u30ed\u30b0\u30a4\u30f3\u3057\u3066\u3044\u307e\u305b\u3093\u3002\u30ed\u30b0\u30a4\u30f3\u3057\u307e\u3059\u304b\uff1f")) {
            ...
            if(confirm("\u533f\u540d\u3067\u30b9\u30b3\u30a2\u767b\u9332\u3057\u307e\u3059\u304b\uff1f")) {
              for(b = "";"" === b;) {
                b = window.prompt("\u4eee\u306e\u30e6\u30fc\u30b6\u30fc\u540d:", this.Ak())
              }
              b !== l && (b = b.substring(0, 10), this.Ig(b + " (\u533f\u540d)", a))
            }else {
              a(l, r)
            }
          }
  ...
  return"\u540d\u7121\u3057\u30b7\u30e5\u30fc\u30bf\u30fc \u5927\u4f50 \u30ec\u30a4\u30cb\u30e3\u30f3\u306b\u3083\u3093 \u30a2\u30a4\u305f\u305d \u3071\u3075\u3047\u2606 \u80fd\u767b\u771f\u7483\u4e9c \u306b\u3083\u3093\u3071\u3059\u30fc \u76f8\u7530\u30de\u30ca".split(" ").pickup()
}, Qg:l, setTimeoutF:function(b, a) {
...
gls2.ja = {mj:r, Ki:60, hj:0, Zg:[1E9, 1E10], jj:3E3, bh:3, ah:[3, 2, 1], ri:[6, 4, 2], lh:1, gj:0.1, dh:1, ij:0.25, ul:1, xl:0.25, qi:2, $i:0.005, Wi:0.01, Xi:0.001, Si:0.015, Ti:0.002, bj:0.001, dj:0.01, aj:0, Zi:0, Yi:0, Vi:0.03, Ui:0.004, cj:0, ej:0, fj:0.75, rf:10, ue:800, Ri:0.25, Qi:0.1, qf:[1, 3, 5, 10, 18, 26, 42, 66, 90, 130, 200], Bi:0.02, Ci:0.5, Ai:0.005, Yg:1E3, vi:10, si:1, Cj:1E3, Bj:100, Aj:0, zj:0, yj:1E3, xj:100, Ii:0.5, wi:3, Di:22500, ti:50, rj:10, Sg:r, pi:j, vj:1E3, wj:2E3, 
sj:4E3, tj:1E4, uj:2E7, lj:100, wl:"tmshooter"};
(function() {
  var b = l, a = {"0":{x:1, y:0}, 45:{x:0.7, y:-0.7}, 90:{x:0, y:-1}, 135:{x:-0.7, y:-0.7}, 180:{x:-1, y:0}, 225:{x:-0.7, y:0.7}, 270:{x:0, y:1}, 315:{x:0.7, y:0.7}};
  gls2.kh = tm.createClass({superClass:tm.display.Sprite, type:0, style:0, Jb:0, Ac:j, Pd:j, Ed:r, da:l, speed:0, Eb:l, wd:l, $h:l, Se:l, Rb:l, kg:l, zc:l, lg:l, mg:l, frame:0, init:function(a, f, h) {
    this.superInit("fighter", 64, 64);
    this.da = a;
    this.type = f;
    this.style = h;
    tm.zb.Tc.Ud.target = this;
    this.speed = [6, 5, 4.5][f];
    this.boundingRadius = 3;
    this.altitude = 10;
    this.wd = this.$h = gls2.nh(f, 100);
    this.Se = gls2.nh(3, 100);
    this.Rb = gls2.gh(this, {redBody:"laserR", greenBody:"laserG", blueBody:"laserB", hyperBody:"laserH", head:"laserHead", foot:"laserFoot", aura:"aura"});
    this.Rb.visible = r;
    this.Tj();
    this.Eb = this.Sj();
    ...
    for(h = this.Eb.length;f < h;f++) {
      var m = this.Eb[f];
      gls2.yi(this, m).setPosition(m.x, m.y).addChildTo(this.zc)
    }
    ...
    this.lg = tm.display.CircleShape(80, 80, {fillStyle:"rgba(0,0,0,0)", strokeStyle:tm.graphics.LinearGradient(0, 0, 0, 80).addColorStopList([{offset:0, color:"rgba(255,255,100,0.0)"}, {offset:0.4, color:"rgba(255,255,100,0.1)"}, {offset:0.5, color:"rgba(255,255,255,1.0)"}, {offset:0.6, color:"rgba(255,255,100,0.1)"}, {offset:1, color:"rgba(255,255,100,0.0)"}]).toStyle(), lineWidth:4}).addChildTo(this);
    this.lg.blendMode = "lighter";
    this.lg.update = function() {
      this.rotation += 2;
      this.visible = 0 < a.Sa && !a.Ka
    };
    this.mg = tm.display.CircleShape(80, 80, {fillStyle:"rgba(0,0,0,0)", strokeStyle:tm.graphics.LinearGradient(0, 0, 0, 80).addColorStopList([{offset:0, color:"rgba(255,255,100,0.0)"}, {offset:0.4, color:"rgba(255,255,100,0.1)"}, {offset:0.5, color:"rgba(255,255,255,1.0)"}, {offset:0.6, color:"rgba(255,255,100,0.1)"}, {offset:1, color:"rgba(255,255,100,0.0)"}]).toStyle(), lineWidth:4}).addChildTo(this);
    this.mg.blendMode = "lighter";
    this.mg.update = function() {
      this.rotation -= 2;
      this.visible = 0 < a.Sa && !a.Ka
    };
    this.Yd = tm.display.CanvasElement(80, 80).addChildTo(this);
    this.Yd.blendMode = "lighter";
    this.Yd.rotation = -90;
    this.Yd.strokeStyle = "rgba(180,180,255,0.4)";
    this.Yd.update = function() {
      this.visible = a.Ka
    };
    this.Yd.draw = function(b) {
      b.lineCap = "round";
      var f = a.Bd / gls2.ja.ue;
    ...
    this.kg = tm.display.Sprite("tex0", 20, 20).addChildTo(this);
    this.kg.setFrameIndex(5);
    this.kg.update = function(a) {
      a = 1.2 + 0.15 * Math.sin(0.2 * a.frame);
      this.scale.set(a, a)
    }
  }, Pc:-1, zd:r, Pb:r, update:function(d) {
    ...
    if(this.Ac) {
      ...
      var m = f.getKey("c") && this.Pd, h = f.getKey("z") && this.Pd;
      this.Pc = m ? this.Pc + 1 : this.Pc - 1;
      this.Pc = gls2.ma.clamp(this.Pc, -1, 10);
      this.Pb = h && m || 10 === this.Pc;
      m = this.da.Ka ? 3 : 5;
      this.zd = !this.Pb && (0 <= this.Pc || h) && 0 === d.frame % m;
      h && (this.Pc = 0);
      this.Rb.x = this.x;
      this.Rb.y = this.y - 40;
      f.getKeyDown("x") && this.Pd && (0 < this.da.Sa && !this.da.Ka ? (this.da.nl(), gls2.Nj(this).addChildTo(this.da)) : !this.da.ed && 0 < this.da.Fb && (this.Bb = gls2.ma.clamp(this.Bb - 2, 0, 1), this.da.Od(-0.02), gls2.Vg(this, this.da).setPosition(gls2.ma.clamp(this.x, 96, 384), Math.max(this.y - 320, 192)).addChildTo(this.da)))
    }else {
      this.Pb = this.zd = r
    }
    this.zd && (h = Math.sin(0.2 * d.frame), m = this.wd.fire(this.x - 7 - 6 * h, this.y - 5, -90), m !== l && m.addChildTo(this.da), m = this.wd.fire(this.x + 7 + 6 * h, this.y - 5, -90), m !== l && m.addChildTo(this.da));
    if(this.Pb) {
      h = 0;
  ...
  gls2.yi = tm.createClass({superClass:tm.display.AnimationSprite, ad:l, ea:l, init:function(a, b) {
    ...
    if(this.ad.v) {
      this.x = this.ad.x * (this.ea.da.Ka ? 1.5 : 1);
      this.y = this.ad.y * (this.ea.da.Ka ? 1.5 : 1);
      ...
      this.ea.zd && (f = this.ea.wd.fire(f.x, f.y, this.parent.rotation + this.rotation - 90), f !== l && f.addChildTo(a.da))
    }else {
...
(function() {
  var b = l;
  gls2.rd = tm.createClass({superClass:tm.display.Sprite, speed:0, Zc:0, ck:1, Sh:0, ib:j, init:function(a) {
  ...
  var a = gls2.rd.pb = [];
  gls2.nh = tm.createClass({Oc:l, Rh:r, init:function(b, f) {
    this.Rh = 3 === b;
    this.Oc = [];
    for(var h = 0;h < f;h++) {
      var m = gls2.rd(b), q = this;
      ...
      this.Rh && m.addEventListener("enterframe", function(a) {
        this.setScale((this.ck + this.Sh) * (0 === a.app.frame % 2 ? 1 : 1.2))
      });
      this.Oc.push(m)
    }
  }, fire:function(a, b, h) {
    ...
    for(var b = this.Oc.length;this.Oc[--b] !== i;) {
      this.Oc[b].Zc = gls2.ja.lh + gls2.ja.gj * a, this.Oc[b].Sh = 0.2 * a
    }
  }})
})();
gls2.gh = tm.createClass({superClass:tm.display.Sprite, ea:l, da:l, kc:0, frame:0, li:l, color:l, vh:0, Zf:0, dk:r, head:l, Jh:l, lc:l, ib:j, Zc:gls2.ja.dh, Fd:l, init:function(b, a) {
  this.ea = b;
  this.da = b.da;
  this.vh = 0 === this.ea.style ? 1 : 1.2;
  this.Zf = 0 === this.ea.style ? 50 : 75;
  var d = this;
  this.li = a;
  this.superInit(a.redBody, this.Zf, 100);
  ...
  this.le(["red", "green", "blue"][this.ea.type]);
  this.Hd(0)
}, le:function(b) {
  this.color = b;
  this.image = tm.asset.AssetManager.get(this.li[this.color + "Body"]);
  this.srcRect.x = 0;
  this.srcRect.y = 0;
  this.srcRect.width = this.image.width / 16;
  this.lc.gotoAndPlay(this.color);
  this.Jh.gotoAndPlay(this.color);
  this.head.gotoAndPlay(this.color);
  this.Fd = l;
  return this
}, Hd:function(b) {
  this.boundingWidth = this.width = this.Zf + 30 * b / gls2.ja.rf;
  this.head.setScale(0.02 * this.width, 0.02 * this.width);
  this.Zc = this.vh * gls2.ja.dh + gls2.ja.ij * b;
  0 === b ? this.le(["red", "green", "blue"][this.ea.type]) : this.le("hyper")
}, Qe:function(b, a) {
  this.Fd === l && this.zh();
  a = a || this.kc;
  for(var d = 0;d < b;d++) {
  ...
  (this.visible = this.ea.Pb) ? (this.kc = Math.max(0, this.kc - 40), this.height = this.y - this.kc, 0 === b.frame % 3 && (this.frame = (this.frame + 1) % 16)) : this.kc = this.y - 40;
  this.dk = this.visible
}, draw:function(b) {
...
(function() {
  gls2.Vg = tm.createClass({superClass:tm.app.Object2D, ib:j, da:l, init:function(a, d) {
    ...
    for(var a = 0;a < this.b;a++) {
      var d = this.a * this.ie + 2 * a * Math.PI / this.b;
      b.clone().setPosition(Math.cos(d) * this.r + this.x, Math.sin(d) * this.r + this.y).addChildTo(this.parent)
    }
    this.a += 0.04;
    a = 0.015 * this.na;
    this.r = 250 * Math.sin(a);
    2 * Math.PI < a ? this.remove() : Math.PI < a ? (this.b = 16, this.na += 3.6, this.ie = -1) : (this.b = 8, this.na += 1.8, this.ie = 1)
  }});
  gls2.hh = tm.createClass({superClass:gls2.Vg, init:function(a, b) {
    this.superInit(a, b);
    gls2.ja.pi && this.addEventListener("added", function() {
      this.da.Fb = 0
    })
  }, th:function() {
    this.core = tm.display.AnimationSprite(tm.asset.SpriteSheet({image:"bomb", frame:{width:280, height:280}, animations:{animation:{frames:Array.range(0, 8), next:"animation", frequency:3}}}), 400, 400).addChildTo(this);
    ...
    Math.PI < a ? this.remove() : (this.b = 8, this.na += 1.8, this.ie = 1)
  }});
  var b = l
})();
gls2.zi = tm.createClass({superClass:tm.display.Sprite, Fc:0, fc:0, ea:l, na:0, init:function(b, a, d) {
  ...
  this.x += this.Fc;
  this.y += 2 * this.fc;
  if(2025 > gls2.Cc(this, this.ea)) {
    this.ea.da.ak(1), this.remove()
  }else {
    if(3E3 > this.na) {
...
gls2.Ji = tm.createClass({superClass:tm.display.Sprite, Fc:0, fc:0, ea:l, na:0, init:function(b, a, d) {
  this.superInit("tex3", 64, 64);
  ...
  this.y += 0.5;
  4096 > gls2.Cc(this, this.ea) && (this.ea.da.Gh(), this.remove());
...
gls2.ra.setup = function() {
  ...
  gls2.kk.explodeL = tm.display.AnimationSprite(tm.asset.SpriteSheet({image:"explode0", frame:{width:100, height:100}, animations:{"default":{frame:Array.range(0, 64), next:l, frequency:3}}}, 100, 100));
...
gls2.of = tm.createClass({superClass:tm.app.Object2D, target:l, fd:0, angle:0, alpha:2, ib:j, reverse:r, init:function(b, a) {
  this.superInit();
  this.target = b;
  this.reverse = a;
  this.angle = 0;
  ...
  if(this.target.parent === l) {
    ...
    if(0 === b.frame % 2) {
      for(b = 0;9 > b;b++) {
        ...
        gls2.Ta(this.reverse ? 100 : 60, this.alpha, 0.9).setPosition(Math.cos(a) * this.fd + this.target.x, Math.sin(a) * this.fd + this.target.y).addChildTo(this.target.parent)
      }
    }
    this.angle += 0.05;
    this.fd += this.reverse ? 4 : -4;
    this.alpha += this.reverse ? -0.02 : 0.05;
    (0 > this.fd || 200 < this.fd) && this.remove()
  }
}});
gls2.Nj = tm.createClass({superClass:tm.app.Object2D, target:l, angle:0, ib:j, init:function(b) {
  this.superInit();
  this.target = b;
  this.angle = 0
}, update:function() {
...
gls2.Ej = tm.createClass({superClass:tm.graphics.Canvas, da:l, ud:l, ub:l, frame:0, init:function(b) {
  ...
  this.fillText(b + "x " + (~~(this.da.Ua / gls2.ja.Yg) + 1), this.ub.Xd + 192, 22);
  ...
  this.setText("bold 18px Orbitron", "left", "top");
  this.strokeText("max " + ~~this.da.ae + " hit", this.ub.Xd + 10, 95);
  0 < ~~this.da.Ua && (this.setText("bold 45px Orbitron", "left", "top"), this.strokeText(~~this.da.Ua + " HIT!!", 10, 0.5 * -this.ub.oc + 115));
  0 === this.frame % 2 && (!this.da.Ka && 0 < this.da.Sa ? (this.strokeStyle = "rgba(255,255,100,0.5)", this.setText("bold 24px Orbitron", "left", "bottom"), this.strokeText("HYPER LV " + this.da.Sa, 5, 637)) : this.da.Ka && (this.strokeStyle = "rgba(255,255,100,0.5)", this.setText("bold 28px Orbitron", "left", "bottom"), this.strokeText("HYPER LV " + this.da.vd, 5, 637)));
  for(a = 0;a < this.da.Fb;a++) {
    this.drawTexture(tm.asset.AssetManager.get("bombIcon"), 480 - 25 * (a + 1) - 20, 615, 20, 20)
  }
  0 === this.frame % 2 && this.da.Ue && (this.strokeStyle = "rgba(255,255,255,0.5)", this.setText("bold 28px Orbitron", "right", "bottom"), this.strokeText("MAXIMUM", 460, 637));
  this.ud.update();
  this.ud.Hg = this.ub.oc + 5;
  this.ud.draw(this);
  this.frame += 1
}});
gls2.mh = tm.createClass({superClass:tm.app.Object2D, Kb:l, Xd:0, oc:0, init:function(b) {
  this.superInit();
  this.Kb = b
}});
(function() {
  ...
  gls2.Oi = tm.createClass({superClass:tm.graphics.Canvas, Ba:l, Ib:l, Tb:l, init:function() {
  ...
  gls2.Pi = tm.createClass({superClass:tm.app.Object2D, bc:0, cc:0, direction:0, speed:0, Ea:0, Fa:0, background:l, init:function() {
    this.superInit();
    this.bc = [];
    this.cc = [];
    for(var a = 0;5 > a;a++) {
...
gls2.Pf = tm.createClass({superClass:tm.display.Sprite, Uh:r, da:l, ea:l, Dc:r, dd:r, Ng:r, Ea:0, Fa:0, init:function(b) {
  ...
  this.ea.Pb && (this.dd = j);
  if(this.ea.parent === l) {
    this.dd = r
  }else {
    if(100 > gls2.Cc(this, this.ea)) {
      this.da.Qk(this);
      this.remove();
      return
    }
    1E4 > gls2.Cc(this, this.ea) && (this.dd = j);
    if(this.Ng && this.dd) {
      var b = Math.atan2(this.ea.y - this.y, this.ea.x - this.x);
      this.x += 8 * Math.cos(b);
      this.y += 8 * Math.sin(b)
    }else {
      this.Ng || (this.x += this.Ea, this.y += this.Fa, this.Ea *= 0.8, this.Fa *= 0.8, -1 < this.Ea && (1 > this.Ea && -1 < this.Fa && 1 > this.Fa) && (this.Ng = j))
    }
  }
  (-200 > this.x || 680 < this.x || -200 > this.y || 690 < this.y) && this.remove()
}});
gls2.oh = tm.createClass({superClass:gls2.Pf, Dc:r, init:function(b) {
  this.superInit(b)
}, update:function() {
  this.y += 4;
  this.rotation += 10;
...
gls2.Mj = tm.createClass({superClass:gls2.Pf, Dc:j, init:function(b) {
  this.superInit(b)
}, update:function() {
  this.dd || (this.x += this.da.pa.Ea, this.y += this.da.pa.Fa);
  this.superClass.prototype.update.call(this)
}});
gls2.Vc = tm.createClass({ea:l, da:l, ba:l, frame:0, init:function(b) {
  this.da = b;
  this.ea = b.ea;
  this.Id();
  this.ba = gls2.Lj();
  this.frame = 0
}, Id:z(), update:function() {
  this.mk(this.frame);
  this.frame += 1
}, mk:function(b) {
  b = this.ba.get(b);
  ...
  a.addChildTo(this.da.hg);
  gls2.ta("warning");
  gls2.ta("voWarning")
}});
gls2.Vc.create = function(b, a) {
  switch(a) {
    case 0:
      return gls2.Gj(b);
    case 1:
...
gls2.Lj = tm.createClass({index:0, data:l, Og:r, init:function() {
  this.data = {}
}, add:function(b, a, d) {
  this.index += b;
  ...
  b = this.data[b];
  return b === i ? l : b.stop === j ? (this.Og = j, b) : this.Og ? l : b
}});
gls2.Gj = tm.createClass({superClass:gls2.Vc, init:function(b) {
  this.superInit(b);
...
gls2.Hj = tm.createClass({superClass:gls2.Vc, init:function(b) {
  this.superInit(b);
  this.ba.add(0, function() {
    gls2.sc("bgm2", j);
    this.da.pa.direction = 0.5 * Math.PI;
...
gls2.Ij = tm.createClass({superClass:gls2.Vc, init:function(b) {
  this.superInit(b);
  this.ba.add(0, function() {
    gls2.sc("bgm3", j);
    this.da.pa.direction = 0.5 * Math.PI;
...
gls2.Jj = tm.createClass({superClass:gls2.Vc, init:function(b) {
  this.superInit(b);
  this.ba.add(0, function() {
    gls2.sc("bgm4", j);
    this.da.pa.direction = 0.5 * Math.PI;
...
gls2.Kj = tm.createClass({superClass:gls2.Vc, init:function(b) {
  this.superInit(b);
  this.ba.add(0, function() {
    gls2.sc("bgm5", j);
    this.da.pa.direction = 0.5 * Math.PI;
...
gls2.Gi = tm.createClass({superClass:gls2.Scene, titleText:l, menu:l, descriptions:l, showExit:r, title:l, selections:[], description:l, box:l, cursor:l, yg:l, _selected:0, _opened:r, _finished:r, init:function(b, a, d) {
  this.superInit();
  this.titleText = b;
  this.menu = a;
  ...
  this.cursor.update = function() {
    this.s !== this.parent._selected && (this.s = this.parent._selected, this.tweener.clear(), this.tweener.to({y:this.parent.selections[this.parent._selected].y}, 200, "easeOutExpo"), this.parent.yg !== l && this.parent.yg(this.s))
  }
}, update:function(b) {
...
function H(b, a, d, f, h) {
  ...
  b.pl(gls2.Gi(a, d, h), f)
}
;gls2.Ta = tm.createClass({superClass:tm.display.CanvasElement, alpha:1, Yf:0.85, size:0, image:l, ib:j, init:function(b, a, d, f) {
  this.superInit();
  ...
  return gls2.Ta(this.size, this.Kl, this.Yf, this.image)
}});
gls2.Ug = tm.createClass({superClass:gls2.Ta, pa:l, init:function(b, a) {
  a = a || 20;
  ...
  return gls2.Ug(this.pa, b)
}});
gls2.Ei = tm.createClass({width:0, label:l, yb:l, na:0, ei:0, Hg:0, init:function(b) {
  this.width = b;
...
gls2.sc = function(b, a) {
  ...
  d && (gls2.hb = d.clone(), gls2.hb.volume = 0.1 * gls2.core.Qd, gls2.hb.loop = j, gls2.hb.play(), f.data[b] && (gls2.hb.source.Ll = f.data[b].start, gls2.hb.source.vg = f.data[b].end))
};
gls2.ef = function() {
  gls2.hb !== l && gls2.hb.source.gl === AudioBufferSourceNode.qj && gls2.hb.stop()
};
gls2.Ne = function() {
  if(gls2.hb !== l) {
    var b = gls2.hb;
    ...
    var a = function() {
      b.volume -= 0.001;
      0 >= b.volume ? b.gl === AudioBufferSourceNode.qj && b.stop() : setTimeout(a, 10)
    };
    setTimeout(a, 10)
  }
};
gls2.ta = function(b) {
  if(0 !== gls2.core.gd && gls2.ta.played[b] !== gls2.core.frame) {
    var a = tm.asset.AssetManager.get("sound/" + b);
    a && (a = a.clone().play(), "vo" === b.substring(0, 2) ? (a.volume = 0.5 * gls2.core.gd, gls2.ta.Rg !== l && gls2.ta.Rg.stop(), gls2.ta.Rg = a) : a.volume = 0.1 * gls2.core.gd);
...
(function() {
  var b = l, a = l;
  gls2.TitleScene = tm.createClass({superClass:gls2.Scene, result:l, na:0, he:[], Pe:r, Nh:l, Wh:0, Ve:0, init:function() {
    this.superInit();
    ...
    this.Nh = tm.display.Label().setPosition(240, 256);
    ...
    for(var a = ("" + Math.floor(gls2.core.Ad)).padding(16, " "), b = "", h = 0;h < a.length;h += 4) {
      b += a.substring(h, h + 4) + " "
    }
    this.Nh.text = "HIGH SCORE: " + b.trim()
  }, yd:function(a) {
    a.fillStyle = "black";
    a.fillRect(0, 0, 480, 640)
  }, update:function(a) {
    this.rh(80 * Math.cos(0.01 * this.na) + 240, 80 * Math.sin(0.01 * this.na) + 320, 0);
    this.rh(80 * Math.cos(0.01 * this.na + Math.PI) + 240, 80 * Math.sin(0.01 * this.na + Math.PI) + 320, 1);
    (a.keyboard.getKeyDown("z") || a.keyboard.getKeyDown("c") || a.keyboard.getKeyDown("space")) && !this.Pe && this.bi();
    this.na += 1
  }, rh:function(d, f, h) {
    if(!this.Pe) {
    ...
    H(this, "MAIN MENU", ["start", "setting"], this.Wk, {defaultValue:this.Wh, menuDescriptions:["\u30b2\u30fc\u30e0\u3092\u958b\u59cb\u3057\u307e\u3059", "\u8a2d\u5b9a\u3092\u5909\u66f4\u3057\u307e\u3059"]})
  }, Wk:function(a) {
    2 !== a && (this.Wh = a);
    switch(a) {
      case 0:
        this.tweener.clear().call(function() {
          this.Pe = j;
          for(var a = 0, b = this.he.length;a < b;a++) {
            this.he[a].speed = 8
          }
        }.bind(this)).wait(1E3).call(function() {
          gls2.core.replaceScene(gls2.Fj())
        }.bind(this));
        break;
      case 1:
        this.Nc()
    ...
    H(this, "SETTING", ["bgm volume", "sound volume"], this.Cg, {defaultValue:this.Ve, menuDescriptions:["BGM\u30dc\u30ea\u30e5\u30fc\u30e0\u3092\u8a2d\u5b9a\u3057\u307e\u3059", "\u52b9\u679c\u97f3\u30dc\u30ea\u30e5\u30fc\u30e0\u3092\u8a2d\u5b9a\u3057\u307e\u3059"]})
  }, Cg:function(a) {
    3 !== a && (this.Ve = a);
    switch(a) {
      case 0:
    ...
    H(this, "BGM VOLUME", "012345".split(""), this.Ag, {defaultValue:gls2.core.Qd, onCursorMove:function(a) {
    ...
    H(this, "SE VOLUME", "012345".split(""), this.Bg, {defaultValue:gls2.core.gd, showExit:r})
  }, Bg:function(a) {
    6 !== a && (gls2.core.gd = a);
    this.Nc()
  }, Ol:function() {
    H(this, "DIFFICULTY", ["easy", "normal", "hard", "very hard", "hell"], this.Vk, {defaultValue:gls2.core.Eh, menuDescriptions:["\u521d\u5fc3\u8005\u3067\u3082\u5b89\u5fc3\u3057\u3066\u6311\u6226\u53ef\u80fd\u306a\u5165\u9580\u30b3\u30fc\u30b9", "\u666e\u901a\u306e\u96e3\u6613\u5ea6\u3002easy\u3067\u306f\u7269\u8db3\u308a\u306a\u3044\u4eba\u3078", "\u4e00\u822c\u7684\u306a\u5f3e\u5e55STG\u306e\u96e3\u6613\u5ea6", "hard\u306f\u30cc\u30eb\u3059\u304e\u308b\u3068\u3044\u3046\u4eba\u5411\u3051", "\u6b7b\u306c\u304c\u3088\u3044"]})
  }, Vk:function(a) {
    5 !== a && (gls2.core.Eh = a);
    this.Nc()
  }, toString:function() {
...
(function() {
  gls2.Fj = tm.createClass({superClass:gls2.Scene, mode:0, types:l, ff:l, Wb:l, Xb:l, Yb:l, rg:l, pg:l, type:0, style:0, Jc:r, Xe:r, init:function() {
    this.superInit();
    ...
    a.addChildTo(this);
    this.rg = tm.display.Label("Type-A").setPosition(240, 150);
    this.rg.addChildTo(a);
    var b = ["\u4e00\u70b9\u96c6\u4e2d\u578b\n\u30b9\u30d4\u30fc\u30c9\uff1a\u6700\u901f\n\n\u7d76\u5927\u306a\u5a01\u529b\u3092\u8a87\u308b\n\u6b63\u9762\u706b\u529b\u3068\n\u30b9\u30d4\u30fc\u30c9\u3067\n\u6575\u3092\u8e42\u8e99\u3059\u308b", "\u53ef\u5909\u578b\n\u30b9\u30d4\u30fc\u30c9\uff1a\u4e2d\n\n\u6b63\u9762\u3068\u4e21\u30b5\u30a4\u30c9\u306b\n\u6483\u3061\u5206\u3051\u3067\u304d\u308b\n\u53ef\u5909\u578b\u30d3\u30c3\u30c8\u3092\u6301\u3064\n\u30c6\u30af\u30cb\u30ab\u30eb\u306a\u6a5f\u4f53", 
    "\u5e83\u7bc4\u56f2\u578b\n\u30b9\u30d4\u30fc\u30c9\uff1a\u9045\n\n\u5e83\u7bc4\u56f2\u306b\u653b\u6483\u53ef\u80fd\u306a\n\u30ef\u30a4\u30c9\u30b7\u30e7\u30c3\u30c8\u3092\n\u6301\u3064\u6a5f\u4f53\n\u9ad8\u3044\u6383\u8a0e\u80fd\u529b"];
    this.sg = tm.display.Label(b[0], 16).setPosition(240, 500);
    this.sg.update = function() {
      this.sg.text = b[this.type]
    }.bind(this);
    ...
    var a = tm.display.CanvasElement();
    a.addChildTo(this);
    this.pg = tm.display.Label("Shot Style").setPosition(240, 150);
    this.pg.addChildTo(a);
    ...
    var d = ["\u30b7\u30e7\u30c3\u30c8\u5f37\u5316\u578b\n\n\u30d3\u30c3\u30c8\u3092\uff14\u3064\u88c5\u5099\u3057\u305f\n\u30b7\u30e7\u30c3\u30c8\u91cd\u8996\u306e\u30b9\u30bf\u30a4\u30eb", "\u30ec\u30fc\u30b6\u30fc\u5f37\u5316\u578b\n\n\u30ec\u30fc\u30b6\u30fc\u306e\u5a01\u529b\u306b\u512a\u308c\n\u5bfe\u5927\u578b\u6a5f\u6226\u3067\n\u6709\u5229\u306a\u30b9\u30bf\u30a4\u30eb", "\u30a8\u30ad\u30b9\u30d1\u30fc\u30c8\u5f37\u5316\u578b\n\n\u30b7\u30e7\u30c3\u30c8\u3068\u30ec\u30fc\u30b6\u30fc\u306e\n\u4e21\u65b9\u304c\u5f37\u5316\u3055\u308c\u305f\u30b9\u30bf\u30a4\u30eb\n\n<<\u30b2\u30fc\u30e0\u96e3\u6613\u5ea6\u304c\u4e0a\u6607\u3057\u307e\u3059\uff01>>\n<<\u4e0a\u7d1a\u8005\u5411\u3051>>"];
    this.qg = tm.display.Label(d[0], 16).setPosition(240, 500);
    this.qg.update = function() {
      this.qg.text = d[this.style]
    }.bind(this);
    this.qg.addChildTo(a);
    return a
  }, update:function(a) {
    if(0 === this.mode) {
      if(this.types.alpha = 1, this.ff.visible = r, !this.Xe && a.keyboard.getKeyDown("left")) {
        this.xg(-1, r), gls2.ta("select")
      }else {
        if(!this.Xe && a.keyboard.getKeyDown("right")) {
          this.xg(1, r), gls2.ta("select")
        }else {
      ...
      1 === this.mode && (this.types.alpha = 0.1, this.ff.visible = j, a.keyboard.getKeyDown("left") ? (this.style = (this.style - 1 + 3) % 3, gls2.ta("select")) : a.keyboard.getKeyDown("right") ? (this.style = (this.style + 1 + 3) % 3, gls2.ta("select")) : a.keyboard.getKeyDown("z") || a.keyboard.getKeyDown("c") || a.keyboard.getKeyDown("space") ? (gls2.ja.Sg ? this.bl() : (this.Jc = j, this.ai()), gls2.ta("decision")) : a.keyboard.getKeyDown("x") && (this.mode = 0), this.sl(0 === ~~(a.frame / 60) % 
      2))
    }
  }, bl:function() {
    H(this, "AUTO BOMB", ["on", "off"], this.Rk, {defaultValue:0, menuDescriptions:["\u88ab\u5f3e\u6642\u306b\u81ea\u52d5\u3067\u30dc\u30f3\u30d0\u30fc\u3092\u6295\u4e0b\u3057\u307e\u3059", "\u30dc\u30f3\u30d0\u30fc\u306e\u6295\u4e0b\u306f\u624b\u52d5\u3067\u306e\u307f\u884c\u3044\u307e\u3059\u3002\u30df\u30b9\u6642\u306b\u6700\u5927\u30dc\u30e0\u6570\u304c\u5897\u52a0\u3057\u307e\u3059"], showExit:j})
  }, Rk:function(a) {
    2 !== a && (this.Jc = 0 === a, this.ai())
  }, ai:function() {
    H(this, "ARE YOU READY?", ["ok"], this.Sk, {defaultValue:0, menuDescriptions:["\u51fa\u6483\u3057\u307e\u3059"], showExit:j})
  }, Sk:function(a) {
    0 === a && this.ml()
  }, xg:function(a, b) {
    this.type = (this.type + a + 3) % 3;
    [this.Wb, this.Xb, this.Yb][this.type].remove().addChildTo(this.types);
    b ? (this.Wb.bb -= a, this.Wb.scaleX = 0 === this.type ? 5 : 1, this.Wb.scaleY = 0 === this.type ? 5 : 1, this.Xb.bb -= a, this.Xb.scaleX = 1 === this.type ? 5 : 1, this.Xb.scaleY = 1 === this.type ? 5 : 1, this.Yb.bb -= a, this.Yb.scaleX = 2 === this.type ? 5 : 1, this.Yb.scaleY = 2 === this.type ? 5 : 1) : (this.Xe = j, this.Wb.tweener.clear().to({bb:this.Wb.bb - a, scaleX:0 === this.type ? 5 : 1, scaleY:0 === this.type ? 5 : 1}, 300), this.Xb.tweener.clear().to({bb:this.Xb.bb - a, scaleX:1 === 
    ...
    this.rg.text = ["Type-A", "Type-B", "Type-C"][this.type]
  }, ml:function() {
    ...
    this.pg.text = ["Shot", "Laser", "Expert"][this.style] + " Style";
...
gls2.Wa = tm.createClass({superClass:gls2.Scene, ea:l, score:0, Td:0, gb:0, Ua:0, ae:0, $a:0, Kc:0, af:0, ne:l, pa:l, Sc:3, bf:0, cf:0, rc:0, Le:0, be:0, wg:0, Jc:r, Fb:0, bd:0, wh:0, ed:r, Ue:r, qc:0, Bb:0, Ka:r, Zd:0, Bd:0, Sa:0, vd:0, Jl:0, Il:0, Re:l, Hh:l, Gg:l, Fh:l, gg:l, hg:l, $f:l, Jk:l, Sb:l, Kb:l, $b:l, Vd:r, Ik:r, Gd:l, init:function() {
  gls2.Wa.Ld !== l && g(Error("class 'gls2.GameScene' is singleton!!"));
  this.superInit();
  gls2.Wa.Ld = this;
  this.Kb = gls2.Ej(this);
  this.Kb.ub.addChildTo(this);
  this.pa = gls2.Oi().Ba;
  this.pa.addChildTo(this);
  this.Re = gls2.Wa.Layer().addChildTo(this);
  this.Hh = gls2.Wa.Layer().addChildTo(this);
  this.Fh = gls2.Wa.Layer().addChildTo(this);
  this.gg = gls2.Wa.Layer().addChildTo(this);
  this.Gg = gls2.Wa.Layer().addChildTo(this);
  this.hg = gls2.Wa.Layer().addChildTo(this);
  this.$f = gls2.Wa.Layer().addChildTo(this);
  this.Jk = gls2.Wa.eh(this).addChildTo(this);
  tm.zb.Tc.Ud.uh = this;
  ...
  b.ib ? this.gg.addChild(b) : b instanceof gls2.Oa ? this.$f.addChild(b) : b instanceof gls2.Pf ? this.Re.addChild(b) : b instanceof gls2.ha ? b.Dc ? this.Re.addChild(b) : this.Fh.addChild(b) : b instanceof gls2.kh ? this.Gg.addChild(b) : b === this.Sb || b === this.pa || b instanceof gls2.Wa.Layer || b instanceof gls2.Wa.eh || b instanceof gls2.mh ? this.superClass.prototype.addChild.apply(this, arguments) : (console.error("unknown type child."), g(Error(b)))
}, update:function(b) {
  this.hl(b.keyboard);
  this.ne.update(b.frame);
  0 === b.frame % 2 && this.Kb.update();
  b.keyboard.getKeyDown("escape") ? (this.app.replaceScene(gls2.TitleScene()), gls2.ef()) : b.keyboard.getKeyDown("space") ? this.ge(0) : b.keyboard.getKeyDown("p") && (this.Mg().saveAsImage(), this.ge(0))
}, Mg:function() {
  ...
  this.ea.Ac === r && gls2.ia.erase();
  var b;
  b = [].concat(gls2.ha.pb);
  for(var a = [].concat(gls2.rd.pb), d = a.length;a[--d] !== i;) {
    for(var f = b.length;b[--f] !== i;) {
      var h = b[f], m = a[d];
      if(!(0 >= h.sa) && gls2.Collision.Cd(h, m) && (m.Qe(1), m.remove(), h.Bc(m.Zc))) {
        this.rc += 1;
        this.Ka ? this.xb(gls2.ja.aj) : this.xb(gls2.ja.$i);
        this.zg(h);
        break
      }
    }
  ...
  if(this.ea.Pb) {
    ...
    for(f = b.length;b[--f] !== i;) {
      if(h = b[f], !(0 >= h.sa) && gls2.Collision.Cd(h, m)) {
        m.il(h.y + h.boundingHeightBottom);
        h.Bc(m.Zc) ? (this.rc += 1, this.Ka ? this.xb(gls2.ja.Zi) : this.xb(gls2.ja.Wi), this.zg(h)) : (this.$a = Math.min(this.$a + 0.02, 1), this.Ka ? (this.sd(0.01 * gls2.ja.qf[this.vd]), this.xb(gls2.ja.Yi)) : (this.sd(0.01), this.xb(gls2.ja.Xi)));
        m.Qe(2);
        break
      }
    }
    ...
    b = [].concat(gls2.ha.pb);
    for(f = b.length;b[--f] !== i;) {
      h = b[f], !(0 >= h.sa) && gls2.Collision.Cd(h, a) && (h.Bc(m.Zc) ? (this.rc += 1, this.Ka ? this.xb(gls2.ja.Vi) : this.xb(gls2.ja.Si), this.zg(h)) : (this.$a = Math.min(this.$a + 0.02, 1), this.Ka ? (this.sd(0.01 * gls2.ja.qf[this.vd]), this.xb(gls2.ja.Ui)) : (this.sd(0.01), this.xb(gls2.ja.Ti))), m.wk(2, this.ea.x, this.ea.y - 30))
    }
  }
  if(this.ed) {
    gls2.ia.erase();
    b = [].concat(gls2.ha.pb);
    for(f = b.length;b[--f] !== i;) {
      h = b[f], !(0 >= h.sa) && (h.dc() && h.Bc(gls2.ja.qi)) && (this.Yc(h.score), this.rc += 1)
    }
    this.$a = this.Ua = 0
  }
  if(this.Ka) {
    ...
    for(h = f.length;f[--h] !== i;) {
      if(m = f[h], !(0 >= m.sa)) {
        ...
        for(b = a.length;a[--b] !== i;) {
          d = a[b], d.visible !== r && (0 < m.sa && gls2.Collision.Cd(m, d)) && (d.sa -= 6 - this.Bb, 0 > d.sa && (d.Da(), this.Yc(gls2.ja.vi), this.sd(gls2.ja.si), this.Lh(r, r, d.x, d.y, 1)), m.sa -= 1)
        }
      }
    }
  }
  if(this.Vd) {
    ...
    if(this.ea.parent !== l && this.ea.Ed === r && this.ed === r && 0 >= this.Zd && !gls2.ja.mj) {
      for(f = gls2.Oa.pb.length;gls2.Oa.pb[--f] !== i;) {
        if(b = gls2.Oa.pb[f], b.visible !== r && gls2.Collision.Cd(b, this.ea)) {
          this.ea.Bc();
          0 < this.Fb && this.Jc ? (this.Bb = gls2.ma.clamp(this.Bb - 1, 0, 1), this.Od(-0.01), gls2.hh(this.ea, this).setPosition(this.ea.x, this.ea.y).addChildTo(this)) : this.Zh();
          break
        }
      }
      for(f = gls2.ha.pb.length;gls2.ha.pb[--f] !== i;) {
        if(h = gls2.ha.pb[f], !(0 >= h.sa) && !h.Dc && gls2.Collision.Cd(h, this.ea)) {
          this.ea.Bc();
          0 < this.Fb && this.Jc ? (this.Bb = gls2.ma.clamp(this.Bb - 1, 0, 1), this.Od(-0.01), gls2.hh(this.ea, this).setPosition(this.ea.x, this.ea.y).addChildTo(this)) : this.Zh();
          break
        }
    ...
    this.Ka && (this.Bd -= 1, 0 >= this.Bd && this.Ke());
    this.Zd = Math.max(this.Zd - 1, 0);
    this.$a -= gls2.ja.Bi * gls2.ja.Ci;
    0 >= this.$a && (this.$a = 0, this.Ka || 0 < this.Sa ? this.Kc = this.Ua = this.gb = 0 : (0 < this.Ua && (0 >= this.Kc && (this.Kc = this.Ua * gls2.ja.Ai), this.gb = this.gb * (this.Ua - this.Kc) / this.Ua, this.Ua -= this.Kc), 0 >= this.Ua && (this.Kc = this.Ua = this.gb = 0)));
    this.Ue && (this.score += gls2.ja.lj)
  }
}, zg:function(b) {
  this.Lh(b.Dc, this.Ka || gls2.Cc(b, this.ea) < gls2.ja.Di, b.x, b.y, b.star, b instanceof gls2.md);
  this.sd(gls2.ja.qf[this.vd]);
  for(var a = this.gb, d = ~~(this.Ua / gls2.ja.Yg) + 1, f = 0;f < d;f++) {
    a += b.score, this.Yc(a)
  }
  this.gb += b.score * d
}, Lh:function(b, a, d, f, h, m) {
  b = b ? gls2.Mj : gls2.oh;
  for(var q = 0;q < h;q++) {
    var v = b(a);
    v.setPosition(d, f);
  ...
  gls2.ta("star");
  b.Uh ? (this.cf += 1, this.gb += gls2.ja.yj, this.Yc(gls2.ja.Cj + this.gb * gls2.ja.Aj), this.Ka ? this.xb(gls2.ja.ej) : this.xb(gls2.ja.dj)) : (this.bf += 1, this.gb += gls2.ja.xj, this.Yc(gls2.ja.Bj + this.gb * gls2.ja.zj), this.Ka ? this.xb(gls2.ja.cj) : this.xb(gls2.ja.bj))
}, start:function(b, a) {
  this.Kb.ud.ek().clear();
  this.Td = this.score = 0;
  this.Sc = gls2.ja.bh;
  this.Fb = this.bd = gls2.ja.ah[a];
  this.wh = gls2.ja.ri[a];
  this.Sa = this.Bb = this.qc = 0;
  this.Ke();
  this.ed = r;
  this.be = this.wg = 0;
  this.ea = gls2.kh(this, b, a);
  this.Lg(gls2.ja.hj);
  G.Ra.Qb.$ex = 2 !== a ? 0 : 1;
  this.ki(0);
  gls2.ta("voLetsGo");
  ...
  this.rc = this.Le = this.cf = this.bf = this.ae = this.$a = this.Ua = this.gb = 0;
  this.$b = l;
  this.Ik = this.Vd = r;
  this.be = 0;
  this.Kb.ub.Xd = 0;
  ...
  this.ea.tweener.clear().moveBy(0, -180, 1E3, "easeOutBack").call(function() {
    this.Pd = this.Ac = j
  }.bind(this.ea)).wait(gls2.ja.jj).call(function() {
    this.Ed = r
  }.bind(this.ea))
}, Zh:function() {
  gls2.ra.Me(this.ea.x, this.ea.y, this);
  ...
  0 < this.Sc ? this.tweener.clear().wait(1E3).call(function() {
    if(!this.Jc || !gls2.ja.Sg) {
      this.bd = Math.min(this.bd + 1, this.wh)
    }
    this.Fb = this.bd;
    this.tg()
  }.bind(this)) : (this.Gd = this.Mg().canvas.toDataURL("image/png"), gls2.core.Ad === this.score && (gls2.core.Dk = this.Gd), this.tweener.clear().wait(2E3).call(function() {
    this.el()
  }.bind(this)))
}, Lg:function(b) {
  G.Ra.Qb.$rank = gls2.ma.clamp(b, 0, 0.5)
}, Od:function(b) {
  this.Lg(G.Ra.Qb.$rank + b)
}, uk:function() {
  this.tb("System rebooted.", j);
  this.score = 0;
  this.Td += 1;
  this.Sc = gls2.ja.bh;
  this.Fb = this.bd = gls2.ja.ah[this.ea.style];
  this.Bb = 0;
  this.Lg(0);
  this.tg()
}, fk:function() {
  ...
  b.tweener.wait(1E3).call(function() {
    this.app.pushScene(gls2.ResultScene(this, this.Mg()));
    b.remove()
  }.bind(this))
}, vk:function() {
  gls2.ef();
  this.app.replaceScene(gls2.Mi())
}, Gl:z(), Yc:function(b) {
  var a = this.score;
  this.score += b;
  for(b = 0;b < gls2.ja.Zg.length;b++) {
    var d = gls2.ja.Zg[b];
    a < d && d <= this.score && this.Gh()
  }
  gls2.core.Ad = Math.max(gls2.core.Ad, this.score);
  gls2.core.Ad === this.score && (gls2.core.Oh = this.af, gls2.core.Qh = this.ea.type, gls2.core.Ph = this.ea.style, gls2.core.Mh = this.Td)
}, sd:function(b) {
  this.Kc = 0;
  this.Ua += b;
  this.ae = Math.max(this.ae, this.Ua);
  1 <= b && (this.$a = 1)
}, xb:function(b) {
  if(this.Sa !== gls2.ja.rf) {
    for(b *= gls2.ja.fj;1 < b;) {
      gls2.of(this.ea).addChildTo(this), b -= 1, this.qc = 0, this.Sa += 1, 1 === this.Sa ? (this.tb("HYPER SYSTEM, stand by.", j), gls2.ta("voHyperStandBy")) : (this.tb("HYPER SYSTEM, ready.", j), gls2.ta("voHyperReady"))
    }
    this.qc = gls2.ma.clamp(this.qc + b, 0, 1);
    1 <= this.qc && (gls2.of(this.ea).addChildTo(this), this.Sa += 1, this.qc -= 1, 1 === this.Sa ? (this.tb("HYPER SYSTEM, stand by.", j), gls2.ta("voHyperStandBy")) : (this.tb("HYPER SYSTEM, ready.", j), gls2.ta("voHyperReady")))
  }
}, nl:function() {
  ...
  this.Od(0.01 * this.Sa);
  G.Ra.Qb.$hyperOff = gls2.ja.Ii * (2 !== this.ea.style ? 1 : 0.5);
  this.Bd = gls2.ja.ue;
  this.Zd = gls2.ja.ue * gls2.ja.Ri;
  this.ea.Se.Hd(this.Sa);
  this.ea.Rb.Hd(this.Sa);
  this.ea.wd = this.ea.Se;
  gls2.ra.xk(this.ea.x, this.ea.y, this);
  this.Ka = j;
  this.vd = this.Sa;
  this.qc = this.Sa = 0;
  gls2.ia.erase(j, j)
}, Ke:function() {
  this.Ka !== r && (this.Ka = r, gls2.of(this.ea, j).addChildTo(this), this.ea.wd = this.ea.$h, G.Ra.Qb.$hyperOff = 1 * (2 !== this.ea.style ? 1 : 0.5), this.ea.Se.Hd(0), this.ea.Rb.Hd(0), this.Zd = gls2.ja.ue * gls2.ja.Qi, this.vd = this.Bd = 0, gls2.ia.erase())
}, ak:function() {
  gls2.ta("decision");
  gls2.ta("voGetBomb");
  this.Fb = Math.min(this.Fb + 1, this.bd);
  this.Ue = this.Fb === this.bd
}, Gh:function() {
  gls2.ta("voExtend");
  this.tb("extended.");
  this.Sc += 1
  ...
  H(this, "PAUSE", ["resume", "setting", "exit game"], this.Yk, {defaultValue:b, menuDescriptions:["\u30b2\u30fc\u30e0\u3092\u518d\u958b\u3057\u307e\u3059", "\u8a2d\u5b9a\u3092\u5909\u66f4\u3057\u307e\u3059", "\u30b2\u30fc\u30e0\u3092\u4e2d\u65ad\u3057\u3001\u30bf\u30a4\u30c8\u30eb\u753b\u9762\u306b\u623b\u308a\u307e\u3059"], showExit:r})
}, Yk:function(b) {
  switch(b) {
    case 1:
      this.Nc();
  ...
  H(this, "REARY?", ["yes", "no"], this.Tk, {defaultValue:1, menuDescriptions:["\u30b2\u30fc\u30e0\u3092\u4e2d\u65ad\u3057\u3001\u30bf\u30a4\u30c8\u30eb\u753b\u9762\u306b\u623b\u308a\u307e\u3059", "\u524d\u306e\u753b\u9762\u3078\u623b\u308a\u307e\u3059"], showExit:r})
}, Tk:function(b) {
  0 === b ? (gls2.ef(), this.app.replaceScene(gls2.TitleScene())) : this.ge(1)
}, Dg:function() {
  H(this, "BGM VOLUME", "012345".split(""), this.Ag, {defaultValue:gls2.core.Qd, onCursorMove:function(b) {
  ...
  H(this, "CONTINUE?", ["yes", "no"], this.Uk, {defaultValue:0, menuDescriptions:["\u30b7\u30b9\u30c6\u30e0\u3092\u518d\u8d77\u52d5\u3057\u3066\u51fa\u6483\u3057\u307e\u3059", "\u4f5c\u6226\u5931\u6557\u3002\u9000\u5374\u3057\u307e\u3059"], showExit:r})
}, Uk:function(b) {
  switch(b) {
    case 0:
      this.uk();
  ...
  this.Kb.ub.tweener.clear().to({Xd:-480}, 1600, "easeInBack").to({oc:30}, 800, "easeInOutBack")
}, Ck:function() {
  this.Kb.ub.tweener.clear().to({oc:0}, 800, "easeInOutBack").to({Xd:0}, 1600, "easeOutBack")
}, je:l, ke:0, $d:l, we:0, ol:function() {
  if(1 === this.we) {
  ...
  if(1 === this.we) {
    1E3 < this.je.length && (console.log("save"), localStorage.setItem("rec" + this.ke, this.je), localStorage.setItem("recCount", this.ke), this.je = [], this.ke += 1), this.je.push("" + ~~b.getKey("up") + ~~b.getKey("down") + ~~b.getKey("left") + ~~b.getKey("right") + ~~b.getKey("z") + ~~b.getKey("x") + ~~b.getKey("c"))
  }else {
    if(2 === this.we && this.$d) {
      var a = this.$d.shift();
...
gls2.Wa.eh = tm.createClass({superClass:tm.display.CanvasElement, da:l, frame:0, init:function(b) {
  this.superInit();
  this.da = b;
  this.blendMode = "lighter"
}, update:function(b) {
  ...
  this.Sa === gls2.ja.rf ? 1 === this.frame % 2 && (b.fillStyle = "rgba(255,255,255,0.3)", b.fillRect(5, 628, 200, 9)) : 0 < this.da.qc && (b.fillStyle = "rgba(255,255,100,0.3)", b.fillRect(5, 628, 200 * this.da.qc, 9))
}});
gls2.Wa.Ld = l;
gls2.ResultScene = tm.createClass({superClass:gls2.Scene, da:l, Gd:l, Sb:l, values:l, labels:l, Te:l, fi:[gls2.ja.vj, gls2.ja.wj, gls2.ja.sj, gls2.ja.tj, 1], Th:l, Jg:l, cursor:0, wait:0, frame:0, init:function(b, a) {
  this.superInit();
  this.da = b;
  tm.display.Sprite("result_bg", 528, 704).setPosition(240, 320).addChildTo(this);
  this.values = [this.da.bf, this.da.cf, ~~(100 * (this.da.rc / this.da.Le)), this.da.ae, 0 === this.da.be ? gls2.ja.uj : 0];
  this.Te = this.values.map(function(a) {
    return 0.01 * a
  });
  ...
  this.Jg = tm.display.Label("press space key").setPosition(240, 576).addChildTo(this);
  this.Jg.visible = r;
  this.Gd = a;
  for(var f = [], d = 0;12 > d;d++) {
    f[d] = [];
    for(var h = 0;16 > h;h++) {
      f[d][h] = {Kg:0, Ze:0, Fc:gls2.ma.randf(-2, 2), fc:gls2.ma.randf(1, 4)}
    }
  }
  this.Sb = tm.app.Object2D();
  this.Sb.draw = function(a) {
    ...
    for(var b = j, d = 0;d < f.length;d++) {
      for(var h = 0;h < f[d].length;h++) {
        var n = f[d][h];
        640 > 40 * h + n.Ze && (a.drawImage(this.Gd.element, 40 * d, 40 * h, 40, 40, 40 * d + n.Kg, 40 * h + n.Ze, 40, 40), n.Kg += n.Fc, n.Ze += n.fc, n.fc += 0.3, b = r)
      }
    }
    this.wait = 60;
    b && this.Sb.remove();
  ...
  if(!(0 < this.wait)) {
    ...
    if(a < this.values.length) {
      gls2.ta("star"), this.values[a] <= this.Te[a] || b.keyboard.getKeyDown("z") || b.keyboard.getKeyDown("c") || b.keyboard.getKeyDown("space") ? (this.da.Yc(this.values[a] * this.fi[a]), this.values[a] = 0, this.cursor += 1, this.wait = 30) : (this.da.Yc(this.Te[a] * this.fi[a]), this.values[a] -= this.Te[a]), this.labels[a].text = "" + Math.floor(this.values[a]) + (2 === a ? "%" : ""), this.Th.text = Math.floor(this.da.score)
    }else {
      if(this.Jg.visible = j, b.keyboard.getKeyDown("z") || b.keyboard.getKeyDown("c") || b.keyboard.getKeyDown("space") || 1800 < this.frame) {
        gls2.ta("decision"), this.da.ki(this.da.af + 1), b.popScene()
      }
    }
    this.frame += 1
  }
}, yd:z()});
gls2.Mi = tm.createClass({superClass:gls2.Scene, na:0, Fg:r, init:function() {
  this.superInit();
  ...
  (b.keyboard.getKeyDown("z") || b.keyboard.getKeyDown("c") || 300 == this.na && !this.Fg) && this.ci();
  this.na += 1
}, yd:function(b) {
  b.clearColor("black")
}, ci:function() {
  this.Fg = j;
  H(this, "GAME OVER", ["save score", "exit"], this.Xk, {defaultValue:0, menuDescriptions:["\u30b9\u30b3\u30a2\u3092\u30e9\u30f3\u30ad\u30f3\u30b0\u30b5\u30fc\u30d0\u30fc\u3078\u9001\u4fe1\u3057\u307e\u3059", "\u30bf\u30a4\u30c8\u30eb\u3078\u623b\u308a\u307e\u3059"], showExit:r})
}, Xk:function(b) {
  0 === b ? this.app.Ig(l, function(a, b, f) {
    a ? this.fl(a) : b ? f ? this.dl(f) : this.app.replaceScene(gls2.TitleScene()) : this.ci()
  }.bind(this)) : this.app.replaceScene(gls2.TitleScene())
}, fl:function() {
  H(this, "ERROR!", ["ok"], z(), {menuDescriptions:["\u767b\u9332\u306b\u5931\u6557\u3057\u307e\u3057\u305f\uff01\uff1e\uff1c"], showExit:r})
}, dl:function(b) {
  H(this, "tweet this score?", ["yes", "no"], function(a) {
    this.Zk(a, b)
  }, {defaultValue:0, menuDescriptions:["\u30b9\u30b3\u30a2\u3092Twitter\u306b\u6295\u7a3f\u3057\u307e\u3059", "\u30bf\u30a4\u30c8\u30eb\u3078\u623b\u308a\u307e\u3059"], showExit:r})
}, Zk:function(b, a) {
  if(0 == b) {
    var d = "TM-Shooter SCORE: {score}(stage{stage} {type}-{style} continue:{cont})".format({score:this.app.Ad, stage:this.app.Oh, type:"ABC"[this.app.Qh], style:["S", "L", "EX"][this.app.Ph], cont:this.app.Mh}), d = tm.social.Twitter.createURL({type:"tweet", text:d, hashtags:"tmshooter", url:"http://tmshooter.dev7.jp/ranking/" + a});
    window.open(d, "tweet", "menubar=no,location=no,resizable=no,scrollbars=no,status=no,width=400,height=400");
    this.app.replaceScene(gls2.TitleScene())
  }else {
    1 == b && this.app.replaceScene(gls2.TitleScene())
  }
}});
gls2.vl = tm.createClass({superClass:gls2.Scene, init:function() {
  this.superInit()
}, update:z()});
(function() {
  gls2.ha = tm.createClass({superClass:tm.display.CanvasElement, name:l, ea:l, da:l, ne:l, sa:0, Mc:0, score:0, Dc:r, erase:r, star:1, Hk:r, Gb:j, Pa:r, frame:0, gf:l, direction:0, speed:0, ga:l, init:function(a, d, f) {
    this.superInit();
    this.addEventListener("added", function() {
      this.frame = 0;
      this.Pa = r;
    ...
    this.sa -= a;
    if(0 >= this.sa) {
      return a = gls2.ma.randf(0, 5), 2 > a ? this.da.tb("enemy destroy.") : 4 > a ? this.da.tb(this.name + " destroy.") : this.da.tb("ETR reaction gone."), this.erase && gls2.ia.erase(j, this.da.Ka, this instanceof gls2.md), this.dispatchEvent(tm.event.Event("destroy")), this.Da(), j
    }
    40 > this.sa && this.Qa();
    return r
  }, Da:function() {
    gls2.ra.Me(this.x, this.y, this.da, this.gf);
    this.remove()
  }, dc:function() {
    ...
    this.remove();
    this.da.Hh.addChild(this);
    this.addEventListener("enterframe", function() {
      0.2 > Math.random() && gls2.ra.Me(this.x + gls2.ma.rand(-100, 100), this.y + gls2.ma.rand(-40, 40), this.da, {x:0, y:-3})
    });
    this.tweener.clear().to({altitude:4, y:this.y + 200}, 2E3).call(function() {
      gls2.ra.ig(this.x, this.y, this.da);
      this.remove()
    }.bind(this))
  }, Fe:function() {
    this.addEventListener("enterframe", function() {
...
gls2.md = tm.createClass({superClass:gls2.ha, Hk:j, Mc:0, $e:l, init:function(b, a, d) {
  this.$e = a;
  this.superInit(b, this.$e[0], d);
  this.Mc = this.sa;
  this.addEventListener("added", function() {
    this.da.$b = this;
    this.da.ll();
  ...
  if(gls2.ha.prototype.Bc.call(this, b)) {
    return this.da.Vd = j, this.da.ea.Pd = r, gls2.Ne(), j
  }
  this.sa <= 0.55 * this.Mc && 0.55 * this.Mc < a ? (gls2.ca.df(this), this.clearEventListener("completeattack"), this.tweener.clear(), gls2.ra.Hb(this.x, this.y, this.da), gls2.ia.erase(j, this.da.Ka), this.$e[1].setup(this)) : this.sa <= 0.1 * this.Mc && 0.1 * this.Mc < a && (gls2.ca.df(this), this.clearEventListener("completeattack"), this.tweener.clear(), gls2.ra.Hb(this.x, this.y, this.da), gls2.ia.erase(j, this.da.Ka), this.$e[2].setup(this), gls2.ta("voJacms"))
}});
(function() {
  gls2.ha.Fi = {kujo:[2, 300, r, r, 1, {radius:24}], kiryu:[3, 400, r, r, 1, {radius:24}], natsuki:[5, 900, j, r, 1, {radius:24}], kise:[50, 15E3, j, r, 1, {radius:24}], yamabuki:[100, 15E3, j, r, 1, {width:140, height:70}], hanasaki:[150, 2E5, j, j, 10, {radius:40}], myodoin:[50, 15E3, j, r, 1, {radius:40}], kenzaki:[200, 3E5, j, j, 10, {width:100, height:40}], minazuki:[300, 3E5, j, j, 10, {width:100, height:40}], tsukikage:[8, 1E3, r, r, 5, {width:100, height:20}], kasugano:[4, 1E3, r, r, 1, {radius:24}], 
  ...
  gls2.ha.oa = tm.createClass({superClass:gls2.ha, fa:l, init:function(a, d) {
  ...
  gls2.ha.za = tm.createClass({superClass:gls2.ha, fa:l, init:function(a, d) {
  ...
  gls2.ha.la = tm.createClass({superClass:gls2.ha, Uf:l, Vf:l, init:function(a, d) {
    this.superInit(a, d, "natsuki");
    this.Uf = b("tex_tank1", 64, 64);
    this.Vf = b("tex_tank1", 64, 64);
    this.$c = this.$c || 0;
    this.mc = this.mc || 0
  }, update:function(a) {
    gls2.ha.prototype.update.call(this, a);
    ...
    this.Uf.setFrameIndex(~~(16 * a / (2 * Math.PI)), 64, 64);
    this.Vf.setFrameIndex(~~(16 * b / (2 * Math.PI)) + 16, 64, 64)
  }, draw:function(a) {
    this.Uf.draw(a);
    this.Vf.draw(a)
  }, Da:function() {
    gls2.ra.nk(this.x, this.y, this.da);
    this.remove()
  }});
  gls2.ha.Wg = tm.createClass({superClass:gls2.ha, fa:l, init:function(a, d) {
    this.superInit(a, d, "yamabuki");
    this.fa = b("tex2", 256, 128).setFrameIndex(7)
  }, Qa:function() {
    this.on("enterframe", function(a) {
      0 === a.app.frame % 30 ? this.fa.kb() : 5 === a.app.frame % 30 && this.fa.jb()
    })
  }, draw:function(a) {
    this.fa.draw(a)
  }, Da:function() {
  ...
  gls2.ha.wb = tm.createClass({superClass:gls2.ha, fa:l, init:function(a, d) {
  ...
  gls2.ha.La = tm.createClass({superClass:gls2.ha, fa:l, init:function(a, d) {
  ...
  gls2.ha.Gc = tm.createClass({superClass:gls2.ha, fa:l, init:function(a, d) {
  ...
  gls2.ha.xc = tm.createClass({superClass:gls2.ha, fa:l, init:function(a, d) {
  ...
  gls2.ha.Df = tm.createClass({superClass:gls2.ha, fa:l, init:function(a, d) {
  ...
  gls2.ha.qd = tm.createClass({superClass:gls2.ha, fa:l, init:function(a, d) {
  ...
  gls2.ha.ye = tm.createClass({superClass:gls2.ha, fa:l, init:function(a, d) {
  ...
  gls2.ha.uf = tm.createClass({superClass:gls2.ha, init:function(a, d) {
  ...
  gls2.ha.mf = tm.createClass({superClass:gls2.ha, fa:l, init:function(a, d) {
  ...
  gls2.ha.qa = tm.createClass({superClass:gls2.ha, fa:l, init:function(a, b) {
  ...
  gls2.ha.hi = tm.createClass({superClass:gls2.ha, fa:l, init:function(a, b) {
  ...
  gls2.ha.de = tm.createClass({superClass:gls2.ha, init:function(a, d) {
  ...
  gls2.ha.ce = tm.createClass({superClass:gls2.ha, init:function(a, d) {
  ...
  gls2.ha.hf = tm.createClass({superClass:gls2.ha, init:function(a, d) {
    ...
    gls2.ra.ig(this.x, this.y, this.da);
    this.nc();
    this.da.ed || gls2.Ji(this.x, this.y, this.ea).addChildTo(this.parent);
    this.remove();
    for(var a = 0;4 > a;a++) {
    ...
    for(var a = 0;4 > a;a++) {
      var b = 0.5 * Math.PI * a;
      this.Ec[a] = this.ne.ug({$:gls2.ha.jf, aa:gls2.ca.jf, x:this.x + 64 * Math.sin(b), y:this.y + 64 * Math.cos(b)});
      this.Ec[a].dir = b;
      this.Ec[a].fg = this;
      this.Ec[a].Pk = a;
      this.Ec[a].distance = 64
    }
    gls2.ha.prototype.fe.call(this);
    return this
  }});
  ...
  gls2.ha.Kd = tm.createClass({superClass:gls2.ha, init:function(a, d) {
    ...
    gls2.ra.Hb(this.x, this.y, this.da);
    gls2.zi(this.x, this.y, this.ea).addChildTo(this.parent);
    this.remove()
  }});
  gls2.ha.sf = tm.createClass({superClass:gls2.ha, fa:l, init:function(a, d) {
  ...
  gls2.ha.Ef = tm.createClass({superClass:gls2.md, fa:l, init:function(a, d) {
  ...
  gls2.ha.zf = tm.createClass({superClass:gls2.ha, init:function(a, d) {
  ...
  gls2.ha.Dj = tm.createClass({superClass:gls2.md, init:function(a, d) {
  ...
  gls2.ha.Of = tm.createClass({superClass:gls2.ha, init:function(a, d) {
  ...
  gls2.ha.kj = tm.createClass({superClass:gls2.md, init:function(a, d) {
  ...
  gls2.ha.Kf = tm.createClass({superClass:gls2.ha, init:function(a, d) {
  ...
  gls2.ha.nj = tm.createClass({superClass:gls2.md, init:function(a, d) {
  ...
  var b = tm.createClass({superClass:tm.display.Sprite, Pg:l, init:function(a, b, f) {
    this.superInit(a, b, f);
    "string" === typeof a && (this.Pg = a)
  }, draw:function(a) {
    var b = this.srcRect;
...
(function() {
  ...
  gls2.ca.pd = gls2.ca.oa("basic0-0", 0.6);
  gls2.ca.lb = gls2.ca.oa("basic1-2", 0.2);
  gls2.ca.vc = gls2.ca.oa("basic1-2", 0.4);
  gls2.ca.od = gls2.ca.oa("basic1-2", 0.6);
  gls2.ca.za = tm.createClass({superClass:gls2.ca, Cb:l, init:function(a) {
    ...
    a.tweener.wait(gls2.ya.rand(0, 1E3)).call(function() {
      ...
      this.on("enterframe", function() {
        this.y < this.ea.y && this.Pa && (this.angle += Math.atan2(this.ea.y - this.y, this.ea.x - this.x) < this.angle ? -0.02 : 0.02, this.angle = gls2.ma.clamp(this.angle, 0.5, Math.PI - 0.5));
        this.x += Math.cos(this.angle) * this.speed;
        this.y += Math.sin(this.angle) * this.speed;
        !this.dc() && this.Pa && this.remove();
        if(22500 > gls2.Cc(this, this.ea) || this.y > this.ea.y + 150) {
          this.Gb = r
        }
      })
    }.bind(a))
  ...
  var b = tm.createClass({superClass:gls2.ca, init:function(a, b, h) {
    ...
    a.on("enterframe", function() {
      ...
      for(this.mc = Math.atan2(this.ea.y - this.y, this.ea.x - this.x);0 > this.mc;) {
        this.mc += 2 * Math.PI
      }
      for(;2 * Math.PI <= this.mc;) {
        this.mc -= 2 * Math.PI
      }
      this.Gb = this.y < this.ea.y && 4E4 < gls2.Cc(this, this.ea);
      if(this.td) {
  ...
  gls2.ca.yl = b(1, -1.75 * Math.PI);
  gls2.ca.Md = b(1, Math.PI, [{frame:200, dir:1.5 * Math.PI, speed:1}]);
  gls2.ca.ua = b(1.6, 0.5 * Math.PI);
  gls2.ca.jc = b(1.6, -0.5 * Math.PI);
  gls2.ca.xi = tm.createClass({superClass:gls2.ca, Ma:l, init:function(a) {
    this.superInit();
    this.Ma = a
  }, setup:function(a) {
  ...
  gls2.ca.Xg = gls2.ca.xi("bukky-4-0");
  b = tm.createClass({superClass:gls2.ca, Ma:l, Ah:r, init:function(a, b) {
    this.superInit();
    this.Ma = a;
    this.Ah = !!b
  }, setup:function(a) {
  ...
  gls2.ca.lf = b("cannon2-3", j);
  gls2.ca.qe = b("cannon3-0", j);
  gls2.ca.nf = b("cannon5-0", j);
  b = tm.createClass({superClass:gls2.ca, velocityY:0, Ma:l, init:function(a, b) {
    ...
    a.on("enterframe", function() {
      this.gi && (this.y += this.velocityY, 384 < this.y && gls2.ca.df(this), this.Pa && !this.dc() && this.remove(), this.Gb = this.y < this.ea.y)
    })
  }});
  gls2.ca.Uc = b(0.5, "kurokawa-1");
  gls2.ca.oj = b(0.5, "kurokawa-4");
  ...
  var a = tm.createClass({superClass:gls2.ca, velocityY:0, Ma:l, init:function(a, b) {
    ...
    a.tweener.clear().call(function() {
      gls2.ca.Ca(this, this.ga[0]);
      gls2.ra.yk(this.x, this.y, this.da)
    }.bind(a));
    a.on("enterframe", function() {
      this.y += this.velocityY;
      this.Pa && !this.dc() && this.remove();
      this.Gb = this.y < this.ea.y
    })
  }});
  ...
  gls2.ca.hi = tm.createClass({superClass:gls2.ca, Cb:l, init:function(a) {
    this.superInit();
    this.Cb = "reika";
    this.speed = a
  }, setup:function(a) {
  ...
  gls2.ca.Ql = gls2.ca.hi(3);
  gls2.ca.de = tm.createClass({superClass:gls2.ca, velocityX:0, Ma:l, init:function(a) {
    this.superInit();
    this.velocityX = a;
    this.Ma = "miyuki_y"
  }, setup:function(a) {
  ...
  gls2.ca.Nk = gls2.ca.de(1);
  gls2.ca.Ok = gls2.ca.de(-1);
  gls2.ca.ce = tm.createClass({superClass:gls2.ca, velocityX:0, Ma:l, init:function(a, b) {
    this.superInit();
    this.velocityX = a;
    this.Ma = b
  }, setup:function(a) {
    ...
    a.on("enterframe", function() {
      0 == this.di ? (this.y += 0.5, 256 < this.y && this.di++) : this.x += this.velocityX;
      this.Pa && !this.dc() && this.remove()
    })
  }});
  gls2.ca.Lk = gls2.ca.ce(-0.5, "miyuki_t");
  gls2.ca.Mk = gls2.ca.ce(0.5, "miyuki_t");
  ...
  gls2.ca.jf = a();
  gls2.ca.fh = b(0.3, "komachi-1");
  gls2.ca.ve = b(0.5, "komachi-2");
  gls2.ca.vf = b(0.5, "komachi-4");
  gls2.ca.Df = tm.createClass({superClass:gls2.ca, ji:0, init:function(a) {
    this.superInit();
    this.ji = a
  }, setup:function(a) {
    tm.app.Tweener(a).to({x:480 * this.ji}, 4E3, "easeOutQuad");
    a.on("enterframe", function() {
      this.y += 0.1
    })
  }});
  gls2.ca.If = b(0.1, "nozomi-4");
  gls2.ca.Jf = b(0.3, "nozomi-5");
  gls2.ca.Kd = tm.createClass({superClass:gls2.ca, init:function() {
    this.superInit()
  }, setup:function(a) {
  ...
  gls2.ca.Kd = gls2.ca.Kd();
  b = tm.createClass({superClass:gls2.ca, ga:l, We:0, init:function(a, b) {
    this.superInit();
    this.ga = a;
    this.We = b || 1500
  }, setup:function(a) {
    ...
    a.on("enterframe", function() {
      if(!(this.cb === r || 0 >= this.sa) && this.We < this.frame && this.Xa === r) {
  ...
  gls2.ca.sf = b(["honoka-1"]);
  gls2.ca.Ef = tm.createClass({superClass:gls2.ca, ga:l, init:function() {
    this.superInit();
  ...
  gls2.ca.pj = gls2.ca.Ef();
  gls2.ca.Ff = tm.createClass({superClass:gls2.ca, ga:l, init:function() {
    this.superInit();
  ...
  gls2.ca.Ff = gls2.ca.Ff();
  gls2.ca.Gf = tm.createClass({superClass:gls2.ca, init:function() {
    this.superInit()
  }, setup:function(a) {
    gls2.ca.prototype.setup.call(this, a);
    a.tweener.clear().wait(800).call(function() {
  ...
  gls2.ca.Mf = tm.createClass({superClass:gls2.ca, ga:l, init:function() {
    this.superInit();
  ...
  gls2.ca.Mf = gls2.ca.Mf();
  gls2.ca.Nf = tm.createClass({superClass:gls2.ca, ga:l, init:function() {
    this.superInit();
  ...
  gls2.ca.xf = tm.createClass({superClass:gls2.ca, ga:l, init:function() {
    this.superInit();
    this.ga = ["saki-1-1", "saki-1-2", "saki-1-3"]
  }, setup:function(a) {
    gls2.ca.prototype.setup.call(this, a);
  ...
  gls2.ca.Kf = b(["rikka-1", "rikka-2", "rikka-3"], 3E3);
  ...
  gls2.ca.Bf = tm.createClass({superClass:gls2.ca, ga:l, init:function() {
    this.superInit();
  ...
  gls2.ca.Cf = gls2.ca.Cf()
})();
(function() {
  var b = gls2.ha, a = gls2.ca;
  gls2.$g = {"heri1-left":[{$:b.za, aa:a.wc, x:48, y:-100}, {$:b.za, aa:a.mb, x:96, y:-100}, {$:b.za, aa:a.wc, x:144, y:-100}, {$:b.za, aa:a.mb, x:192, y:-100}, {$:b.za, aa:a.wc, x:240, y:-100}], "heri1-center":[{$:b.za, aa:a.wc, x:144, y:-100}, {$:b.za, aa:a.mb, x:192, y:-100}, {$:b.za, aa:a.wc, x:240, y:-100}, {$:b.za, aa:a.mb, x:288, y:-100}, {$:b.za, aa:a.wc, x:336, y:-100}], "heri1-right":[{$:b.za, aa:a.wc, x:240, y:-100}, {$:b.za, aa:a.mb, x:288, y:-100}, {$:b.za, aa:a.wc, x:336, y:-100}, {$:b.za, 
  aa:a.mb, x:384, y:-100}, {$:b.za, aa:a.wc, x:432, y:-100}], "heri1-left2":[{$:b.za, aa:a.mb, x:48, y:-100}, {$:b.za, aa:a.pd, x:96, y:-100}, {$:b.za, aa:a.mb, x:144, y:-100}, {$:b.za, aa:a.pd, x:192, y:-100}, {$:b.za, aa:a.mb, x:240, y:-100}], "heri1-center2":[{$:b.za, aa:a.mb, x:144, y:-100}, {$:b.za, aa:a.pd, x:192, y:-100}, {$:b.za, aa:a.mb, x:240, y:-100}, {$:b.za, aa:a.pd, x:288, y:-100}, {$:b.za, aa:a.mb, x:336, y:-100}], "heri1-right2":[{$:b.za, aa:a.mb, x:240, y:-100}, {$:b.za, aa:a.pd, 
  x:288, y:-100}, {$:b.za, aa:a.mb, x:336, y:-100}, {$:b.za, aa:a.pd, x:384, y:-100}, {$:b.za, aa:a.mb, x:432, y:-100}], "heri2-left":[{$:b.oa, aa:a.nb, x:48, y:-100}, {$:b.oa, aa:a.nb, x:96, y:-100}, {$:b.oa, aa:a.nb, x:144, y:-100}, {$:b.oa, aa:a.nb, x:192, y:-100}, {$:b.oa, aa:a.nb, x:240, y:-100}], "heri2-center":[{$:b.oa, aa:a.nb, x:144, y:-100}, {$:b.oa, aa:a.nb, x:192, y:-100}, {$:b.oa, aa:a.nb, x:240, y:-100}, {$:b.oa, aa:a.nb, x:288, y:-100}, {$:b.oa, aa:a.nb, x:336, y:-100}], "heri2-right":[{$:b.oa, 
  ...
  x:-192, y:320}, {$:b.wb, aa:a.Wc(300), x:-288, y:320}, {$:b.wb, aa:a.Wc(200), x:-144, y:256}, {$:b.wb, aa:a.Wc(100), x:-240, y:256}], "urara5-0":function() {
    ...
    return d
  }(), "komachi-0":[{$:b.xc, aa:a.fh, x:144, y:-192}], "komachi-1":[{$:b.xc, aa:a.fh, x:336, y:-192}], "komachi2-0":[{$:b.xc, aa:a.ve, x:144, y:-192}], "komachi2-1":[{$:b.xc, aa:a.ve, x:336, y:-192}], "komachi3-0":[{$:b.xc, aa:a.ve, x:144, y:-192}], "komachi3-1":[{$:b.xc, aa:a.ve, x:336, y:-192}], "komachi4-0":[{$:b.xc, aa:a.vf, x:144, y:-192}], "komachi4-1":[{$:b.xc, aa:a.vf, x:336, y:-192}], "komachi4-2":[{$:b.xc, aa:a.vf, x:240, y:-192}], "nozomi4-0":[{$:b.qd, aa:a.If, x:144, y:-192}], "nozomi4-1":[{$:b.qd, 
  aa:a.If, x:240, y:-192}], "nozomi4-2":[{$:b.qd, aa:a.If, x:336, y:-192}], "nozomi5-0":[{$:b.qd, aa:a.Jf, x:144, y:-320}], "nozomi5-1":[{$:b.qd, aa:a.Jf, x:240, y:-192}], "nozomi5-2":[{$:b.qd, aa:a.Jf, x:336, y:-320}], "mktn5-0":[{$:b.Df, aa:a.Df(0.7), x:624, y:128}], "akane-center":[{$:b.Ja, aa:a.Ja, x:144, y:130}, {$:b.Ja, aa:a.Ja, x:192, y:80}, {$:b.Ja, aa:a.Ja, x:240, y:140}, {$:b.Ja, aa:a.Ja, x:288, y:80}, {$:b.Ja, aa:a.Ja, x:336, y:130}], "akane-right":[{$:b.Ja, aa:a.Ja, x:384, y:160}, {$:b.Ja, 
  ...
  y:-100}], "nao3-right":[{$:b.qa, aa:a.sb, x:240, y:-100}, {$:b.qa, aa:a.sb, x:288, y:-100}, {$:b.qa, aa:a.sb, x:336, y:-100}, {$:b.qa, aa:a.sb, x:384, y:-100}, {$:b.qa, aa:a.sb, x:432, y:-100}], "nao3-center":[{$:b.qa, aa:a.sb, x:144, y:-100}, {$:b.qa, aa:a.sb, x:192, y:-100}, {$:b.qa, aa:a.sb, x:240, y:-100}, {$:b.qa, aa:a.sb, x:288, y:-100}, {$:b.qa, aa:a.sb, x:336, y:-100}], hoshizora_y1:[{$:b.de, aa:a.Nk, x:-256, y:140}], hoshizora_y2:[{$:b.de, aa:a.Ok, x:608, y:60}], hoshizora_t1:[{$:b.ce, 
  aa:a.Lk, x:336, y:-128}], hoshizora_t2:[{$:b.ce, aa:a.Mk, x:144, y:-128}], yotsuba:[{$:b.hf, aa:a.hf, x:240, y:-64}], erika:[{$:b.Kd, aa:a.Kd, x:240, y:-100}], yukishiro:[{$:b.sf, aa:a.sf, x:240, y:-100}], misumi:[{$:b.Ef, aa:[a.pj, a.Ff, a.Gf], x:240, y:-100, $b:j}], mai:[{$:b.zf, aa:a.zf, x:780, y:128}], hyuga:[{$:b.Dj, aa:[a.Lf, a.Mf, a.Nf], x:240, y:-100, $b:j}], higashi:[{$:b.Of, aa:a.Of, x:780, y:128}], momozono:[{$:b.kj, aa:[a.wf, a.xf, a.yf], x:240, y:-100, $b:j}], rikka:[{$:b.Kf, aa:a.Kf, 
  x:240, y:-100}], mana:[{$:b.nj, aa:[a.Af, a.Bf, a.Cf], x:240, y:-100, $b:j}]}
})();
(function() {
  function b(a, b, d, f) {
  ...
  function N(a) {
    return c.Ha(a, {frame:3, ee:j})
  }
  function O(a) {
    return c.Ha(a, {frame:2, ee:j})
  }
  function E(a) {
  ...
  gls2.ia["cannon5-0"] = new G.ka({top0:c.action([c.repeat(999, [c.fire(c.direction(-60), q, E(c.xa("b"))), c.repeat(11, [k(5), c.fire(c.direction(10, "sequence"), q, E(c.xa("b")))]), k(60)])]), b:c.action([c.wait(5), c.He(c.speed(0), 0), b(p, 0.1, 5, function(a) {
  ...
  gls2.ia["saki-1-1"] = new G.ka({top:c.action([k(100), c.repeat(3, [c.xa("oneround", "9 + $loop.index * 4", "$loop.index > 0 ? 0 : 1")])]), oneround:c.action([c.Ga("way", "$1"), c.repeat("30", [f("$way", "3 * $loop.index*+1", "3 * $loop.index*+1 + 360", n, C), f("$way", "3 * $loop.index*-1", "3 * $loop.index*-1 + 360", n, C), k(12)]), c.repeat("$2", [f(9, -20, 20, w, I)])])});
  ...
  gls2.ia["saki-1-3"] = new G.ka({top:c.action([c.Ga("dir", "$rand < 0.5 ? -1 : 1"), c.repeat(24, [c.fire(c.direction("120*$dir + $loop.index*10*-$dir"), c.speed(2), A(c.xa("seed"))), k(8)]), k(60)]), seed:c.action([c.wait(10), c.He(c.speed(0), 50), c.wait(90), f(13, 0, 360 - 360 / 13, p, I), c.Ya])});
  ...
  "($s-$loop.index)*0.5"), f(41, -180 + 360 / 41 / 2, 180 - 360 / 41 / 2, w("$ss"), I, c.offsetX(-30), c.offsetY(-30))]), k(5), c.repeat(5, [c.Ga("ss", "($s-$loop.index)*0.5"), f(41, -180 + 360 / 41 / 2, 180 - 360 / 41 / 2, w("$ss"), I, c.offsetX(30), c.offsetY(-30))]), k(20), c.repeat(5, [c.Ga("ss", "($s-$loop.index)*0.5"), a(42, -180 + 360 / 42 / 2, 180 - 360 / 42 / 2, v("$ss"), t, c.offsetX(30), c.offsetY(-30))]), k(5), c.repeat(5, [c.Ga("ss", "($s-$loop.index)*0.5"), a(42, -180 + 360 / 42 / 2, 
  ...
  gls2.ia.setup = function() {
    ...
    a.xh = function(a) {
      var b = M.shift(0);
      if(b) {
        return b.sa = gls2.ja.ti, L.push(b), b.setFrameIndex(a.frame === i ? 1 : a.frame), b.blendMode = "source-over", a.Zb ? (b.scaleX = 1, b.scaleY = 1, b.Rc = r) : (a.ee ? (b.scaleX = 0.4, b.scaleY = 1.5) : a.Rb ? (b.scaleX = 1, b.scaleY = 10, b.blendMode = "lighter") : (b.scaleX = 0.8, b.scaleY = 1.5), b.Rc = j), b.visible = a.visible === r ? r : j, b.Zb = !!a.Zb, b.ee = !!a.ee, b.Rb = !!a.Rb, b
      }
      console.warn("\u5f3e\u304c\u8db3\u308a\u306a\u3044\uff01")
    };
    a.Bh = function(a) {
  ...
  gls2.Oa = tm.createClass({superClass:tm.display.Sprite, sa:0, Zb:r, ee:r, init:function() {
    ...
    var a = gls2.Oa.Wd().setScale(0.1, 0.1).setPosition(this.x, this.y);
  ...
  gls2.Oa.Wd = function() {
    gls2.Oa.Wd.ag === l && (gls2.Oa.Wd.ag = gls2.Ta(10, 1, 0.92, tm.graphics.Canvas().resize(10, 10).setFillStyle(tm.graphics.RadialGradient(5, 5, 0, 5, 5, 5).addColorStopList([{offset:0, color:"rgba(255,100,100,0.0)"}, {offset:0.3, color:"rgba(255,100,100,0.0)"}, {offset:0.9, color:"rgba(255,180,180,1.0)"}, {offset:1, color:"rgba(255,100,100,0.0)"}]).toStyle()).fillRect(0, 0, 10, 10).element));
    return gls2.Oa.Wd.ag.clone()
  };
  gls2.Oa.Wd.ag = l;
  var M = [], L = gls2.Oa.pb = []
})();
