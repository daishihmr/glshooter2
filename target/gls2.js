...
(function() {
  ...
  q.td.prototype.clone = function(a) {
    var b = a.pa;
    a.pa = a.Be(this.Ia);
    var f = this.root.mi(this.label).clone(a);
    a.pa = b;
    return f
  };
  ...
  if(this.Oa !== k) {
    ...
    if(b !== i) {
      ...
      if(b instanceof q.Cc) {
        return this.Xc(), this.Oa = this.Nf.ki(b.label), this.pa = this.Be(b.Ia), this.next()
      }
...
q.ra = function(b) {
  b = b || "";
  for(var a in q.ra) {
    q.ra.hasOwnProperty(a) && (q.Xg[b + a] = q.ra[a])
  }
};
...
(function() {
  ...
  tm.Ya.ic = tm.createClass({init:function(a) {
    ...
    if(this.Ni === i || this.bc) {
      var D = {label:b.wa.label}, v;
      for(v in b.wa.Ba) {
        D[v] = b.wa.Ba[v]
      }
      if(D = d.Vf(D)) {
        B = (v = 0 === b.wa.La.length) ? B.Ph(d) : B.Md(d, b.wa);
  ...
  tm.Ya.ic.bd = {Vf:tm.Ya.bi, Ue:tm.Ya.Zf, xj:0, gc:m, yc:2, target:k};
...
var s = k, gls2 = {}, u, ba, w, z, C, F, ca, da, ea, fa, ga, ha, ia, G, I, K, ka, la, ma, na, oa, pa, qa, ra, sa, ta, ua, va, wa, ya, za, Aa, Ba, L, Ca, Da, N, O, Ea, Fa, R, aa = tm.createClass({superClass:tm.display.CanvasApp, Vd:0, rj:0, Zc:3, wc:3, bg:1, ca:k, init:function(b) {
...
;u = {uh:m, Wg:60, rh:0, Af:[1E9, 1E10], th:3E3, Cf:3, Bf:[3, 2, 1], Jg:[6, 4, 2], Jf:1, qh:0.1, Df:1, sh:0.25, cj:1, ej:0.25, Ig:2, ih:0.005, eh:0.01, fh:0.001, $g:0.015, ah:0.002, kh:0.001, mh:0.01, jh:0, hh:0, gh:0, dh:0.03, bh:0.004, lh:0, nh:0, oh:0.75, le:10, yd:800, Zg:0.25, Yg:0.1, ph:[1, 3, 5, 10, 18, 26, 42, 66, 90, 130, 200], Qg:0.02, Rg:0.5, Pg:0.01, zf:1E3, Mg:10, Kg:1, Hh:1E3, Gh:100, Fh:0, Eh:0, Dh:1E3, Ch:100, Vg:0.6, Ng:4, Sg:22500, Lg:50, wh:10, vf:m, Hg:m, Ah:1E3, Bh:2E3, xh:4E3, 
yh:1E4, zh:2E7};
(function() {
  ...
  ca = tm.createClass({superClass:tm.display.Sprite, type:0, style:0, gb:0, Rb:j, Yc:j, Pc:m, ca:k, speed:0, bb:k, Ic:k, tg:k, Wd:k, Ub:k, Pe:k, Pb:k, Qe:k, Re:k, frame:0, init:function(a, f, g) {
    ...
    this.Ci = tm.display.CircleShape(140, 140, {strokeStyle:"rgba(0,0,0,0)", fillStyle:tm.graphics.RadialGradient(70, 70, 0, 70, 70, 70).addColorStopList([{offset:0, color:"rgba(255,255,255,0.1)"}, {offset:0.5, color:"rgba(255,255,255,0.1)"}, {offset:1, color:"rgba(255,255,255,0.0)"}]).toStyle()}).addChildTo(this);
    this.Ci.blendMode = "lighter";
    ...
    this.wi = tm.display.CircleShape(80, 80, {fillStyle:tm.graphics.RadialGradient(40, 40, 0, 40, 40, 35).addColorStopList([{offset:0, color:"rgba(0,0,50,0.0)"}, {offset:0.9, color:"rgba(0,0,50,0.8)"}, {offset:1, color:"rgba(0,0,50,0.0)"}]).toStyle(), strokeStyle:"rgba(0,0,0,0)"}).addChildTo(this);
    this.wi.update = function() {
      this.visible = a.ua
    };
    b === k && (b = ga(this.ca.na))
  }, Nh:function() {
    ...
    if(this.Rb) {
      ...
      this.Ub.x = this.x;
      this.Ub.y = this.y - 40;
      f.getKeyDown("x") && this.Yc && (0 < this.ca.za && !this.ca.ua ? (this.ca.Yi(), ha(this).addChildTo(this.ca)) : !this.ca.Nc && 0 < this.ca.cb && (this.$a = S(this.$a - 2, 0, 1), q.ya.Qa.$rank = S(q.ya.Qa.$rank - 0.02, 0, 1), ia(this, this.ca).setPosition(S(this.x, 96, 384), Math.max(this.y - 320, 192)).addChildTo(this.ca)))
    }else {
      this.wb = this.Lc = m
    }
...
(function() {
  var b = k;
  G = tm.createClass({superClass:tm.display.Sprite, speed:0, oc:0, Xh:1, kg:0, eb:j, init:function(a) {
  ...
  da = tm.createClass({ec:k, jg:m, init:function(b, f) {
    ...
    for(var g = 0;g < f;g++) {
      ...
      this.jg && l.addEventListener("enterframe", function(a) {
        this.setScale((this.Xh + this.kg) * (0 === a.app.frame % 2 ? 1 : 1.2))
      });
      this.ec.push(l)
    }
  }, ea:function(a, b, g) {
    ...
    for(var b = this.ec.length;this.ec[--b] !== i;) {
      this.ec[b].oc = u.Jf + u.qh * a, this.ec[b].kg = 0.2 * a
    }
  }})
})();
ea = tm.createClass({superClass:tm.display.Sprite, da:k, ca:k, Db:0, frame:0, Dg:k, color:k, Sf:0, Ge:0, Yh:m, head:k, gg:k, Rf:k, eb:j, oc:u.Df, Qc:k, init:function(b, a) {
  this.da = b;
  this.ca = b.ca;
...
ua = tm.createClass({da:k, ca:k, $:k, frame:0, init:function(b) {
  ...
  this.ca.Pd += 1;
  b = b.aa(this.ca, b.ba).setPosition(b.x, b.y).addChildTo(this.ca).Ei();
  b.de = this;
  return b
}, Qf:function(b) {
  ya();
...
;I = tm.createClass({superClass:tm.display.CanvasElement, alpha:1, Fe:0.85, size:0, image:k, eb:j, init:function(b, a, d, f) {
  ...
  return I(this.size, this.uj, this.Fe, this.image)
}});
...
(function() {
  ...
  ba = tm.createClass({superClass:Ma, result:k, ha:0, ld:[], Sd:m, ig:k, og:0, Yd:0, init:function() {
    ...
    W(this, "MAIN MENU", ["start", "tutorial", "setting", "save score"], this.Ki, {defaultValue:this.og, menuDescriptions:["\u30b2\u30fc\u30e0\u3092\u958b\u59cb\u3057\u307e\u3059", "\u30c1\u30e5\u30fc\u30c8\u30ea\u30a2\u30eb\u3092\u958b\u59cb\u3057\u307e\u3059", "\u8a2d\u5b9a\u3092\u5909\u66f4\u3057\u307e\u3059", "\u30b2\u30fc\u30e0\u3092\u7d42\u4e86\u30579leap\u306b\u30b9\u30b3\u30a2\u3092\u767b\u9332\u3057\u307e\u3059"]})
  }, Ki:function(a) {
    4 !== a && (this.og = a);
    switch(a) {
      case 0:
    ...
    W(this, "DIFFICULTY", ["easy", "normal", "hard", "very hard", "hell"], this.Ji, {defaultValue:s.bg, menuDescriptions:["\u521d\u5fc3\u8005\u3067\u3082\u5b89\u5fc3\u3057\u3066\u6311\u6226\u53ef\u80fd\u306a\u5165\u9580\u30b3\u30fc\u30b9", "\u666e\u901a\u306e\u96e3\u6613\u5ea6\u3002easy\u3067\u306f\u7269\u8db3\u308a\u306a\u3044\u4eba\u3078", "\u4e00\u822c\u7684\u306a\u5f3e\u5e55STG\u306e\u96e3\u6613\u5ea6", "hard\u306f\u30cc\u30eb\u3059\u304e\u308b\u3068\u3044\u3046\u4eba\u5411\u3051", "\u6b7b\u306c\u304c\u3088\u3044"]})
  }, Ji:function(a) {
    5 !== a && (s.bg = a);
    this.dc()
  }, toString:function() {
...
(function() {
  Da = tm.createClass({superClass:Ma, mode:0, types:k, ge:k, qb:k, rb:k, sb:k, Xe:k, Ve:k, type:0, style:0, Zb:m, Zd:m, init:function() {
    ...
    if(0 === this.mode) {
      ...
      1 === this.mode && (this.types.alpha = 0.1, this.ge.visible = j, a.keyboard.getKeyDown("left") ? (this.style = (this.style - 1 + 3) % 3, K("select")) : a.keyboard.getKeyDown("right") ? (this.style = (this.style + 1 + 3) % 3, K("select")) : a.keyboard.getKeyDown("z") || a.keyboard.getKeyDown("c") || a.keyboard.getKeyDown("space") ? (u.vf ? this.Oi() : (this.Zb = j, this.ug()), K("decision")) : a.keyboard.getKeyDown("x") && (this.mode = 0), this.aj(0 === ~~(a.frame / 60) % 2))
    }
  }, Oi:function() {
    W(this, "AUTO BOMB", ["on", "off"], this.Fi, {defaultValue:0, menuDescriptions:["\u88ab\u5f3e\u6642\u306b\u81ea\u52d5\u3067\u30dc\u30f3\u30d0\u30fc\u3092\u6295\u4e0b\u3057\u307e\u3059", "\u30dc\u30f3\u30d0\u30fc\u306e\u6295\u4e0b\u306f\u624b\u52d5\u3067\u306e\u307f\u884c\u3044\u307e\u3059\u3002\u30df\u30b9\u6642\u306b\u6700\u5927\u30dc\u30e0\u6570\u304c\u5897\u52a0\u3057\u307e\u3059"], showExit:j})
  }, Fi:function(a) {
    2 !== a && (this.Zb = 0 === a, this.ug())
  }, ug:function() {
    W(this, "ARE YOU READY?", ["ok"], this.Gi, {defaultValue:0, menuDescriptions:["\u51fa\u6483\u3057\u307e\u3059"], showExit:j})
  }, Gi:function(a) {
    0 === a && this.Xi()
  }, af:function(a, b) {
...
F = tm.createClass({superClass:Ma, da:k, score:0, Ma:0, Aa:0, jd:0, Ha:0, $b:0, Bg:0, de:k, na:k, hc:3, ee:0, fe:0, Kb:0, Pd:0, kd:0, $e:0, Zb:m, cb:0, rc:0, Tf:0, Nc:m, Se:m, Jb:0, $a:0, ua:m, fd:0, Mc:0, za:0, Nd:0, tj:0, sj:0, Ud:k, eg:k, jf:k, cg:k, Le:k, Me:k, He:k, Bi:k, nb:k, hb:k, Qb:k, cd:m, Ai:m, init:function() {
  ...
  this.Bi = F.Ef(this).addChildTo(this);
  tm.Ya.ic.bd.Pf = this;
  ...
  for(var a = [].concat(G.Pa), d = a.length;a[--d] !== i;) {
    for(var f = b.length;b[--f] !== i;) {
      ...
      if(!(0 >= g.oa) && La(g, l) && (l.Td(1), l.remove(), g.Sb(l.oc))) {
        this.Kb += 1;
        this.ua ? this.Va(u.jh) : this.Va(u.ih);
        this.cf(g);
        break
      }
    }
  ...
  if(this.da.wb) {
    ...
    for(f = b.length;b[--f] !== i;) {
      if(g = b[f], !(0 >= g.oa) && La(g, l)) {
        l.Ti(g.y + g.boundingHeightBottom);
        g.Sb(l.oc) ? (this.Kb += 1, this.ua ? this.Va(u.hh) : this.Va(u.eh), this.cf(g)) : (this.ua ? this.Ec(0.01 * this.za) : this.Ec(0.01), this.Ha = Math.min(this.Ha + 0.02, 1), this.ua ? this.Va(u.gh) : this.Va(u.fh));
        l.Td(2);
        break
      }
    }
    ...
    b = [].concat(O.Pa);
    for(f = b.length;b[--f] !== i;) {
      g = b[f], !(0 >= g.oa) && La(g, a) && (g.Sb(l.oc) ? (this.Kb += 1, this.ua ? this.Va(u.dh) : this.Va(u.$g), this.cf(g)) : (this.ua ? this.Ec(0.01 * this.za) : this.Ec(0.01), this.Ha = Math.min(this.Ha + 0.02, 1), this.ua ? this.Va(u.bh) : this.Va(u.ah)), l.ri(2, this.da.x, this.da.y - 30))
    }
  }
  if(this.Nc) {
    z.erase();
  ...
  if(this.cd) {
    ...
    if(this.da.parent !== k && this.da.Pc === m && this.Nc === m && 0 >= this.fd && !u.uh) {
    ...
    this.Ha -= u.Qg * u.Rg;
    0 >= this.Ha && (this.Ha = 0, this.ua || 0 < this.za ? this.$b = this.Aa = this.Ma = 0 : (0 < this.Aa && (0 >= this.$b && (this.$b = this.Aa * u.Pg), this.Ma = this.Ma * (this.Aa - this.$b) / this.Aa, this.Aa -= this.$b), 0 >= this.Aa && (this.$b = this.Aa = this.Ma = 0)))
  }
}, cf:function(b) {
  this.hg(b.Tb, this.ua || Ga(b, this.da) < u.Sg, b.x, b.y, b.star, b instanceof Ea);
  this.Ec(u.ph[this.Nd]);
  ...
  K("star");
  b.mg ? (this.fe += 1, this.Ma += u.Dh, this.nc(u.Hh + this.Ma * u.Fh), this.ua ? this.Va(u.nh) : this.Va(u.mh)) : (this.ee += 1, this.Ma += u.Ch, this.nc(u.Gh + this.Ma * u.Eh), this.ua ? this.Va(u.lh) : this.Va(u.kh))
}, start:function(b, a) {
  this.hb.Hc.Zh().clear();
  this.score = 0;
  this.hc = u.Cf;
  ...
  this.da.tweener.clear().moveBy(0, -180, 1E3, "easeOutBack").call(function() {
    this.Yc = this.Rb = j
  }.bind(this.da)).wait(u.th).call(function() {
    this.Pc = m
  }.bind(this.da))
}, sg:function() {
  ...
  q.ya.Qa.$hyperOff = u.Vg;
  this.Mc = u.yd;
  this.fd = u.yd * u.Zg;
  this.da.Wd.Rc(this.za);
  this.da.Ub.Rc(this.za);
  this.da.Ic = this.da.Wd;
  C.si(this.da.x, this.da.y, this);
  this.ua = j;
  this.Nd = this.za;
  this.Jb = this.za = 0;
  z.erase(j, j)
}, Od:function() {
  this.ua !== m && (this.ua = m, ma(this.da, j).addChildTo(this), this.da.Ic = this.da.tg, q.ya.Qa.$hyperOff = 1, this.da.Wd.Rc(0), this.da.Ub.Rc(0), this.fd = u.yd * u.Yg, this.Nd = this.Mc = 0, z.erase())
}, ij:function() {
  K("decision");
  K("voGetBomb");
  ...
  W(this, "PAUSE", ["resume", "setting", "exit game"], this.Li, {defaultValue:b, menuDescriptions:["\u30b2\u30fc\u30e0\u3092\u518d\u958b\u3057\u307e\u3059", "\u8a2d\u5b9a\u3092\u5909\u66f4\u3057\u307e\u3059", "\u30b2\u30fc\u30e0\u3092\u4e2d\u65ad\u3057\u3001\u30bf\u30a4\u30c8\u30eb\u753b\u9762\u306b\u623b\u308a\u307e\u3059"], showExit:m})
}, Li:function(b) {
  switch(b) {
    case 1:
      this.dc();
  ...
  W(this, "REARY?", ["yes", "no"], this.Hi, {defaultValue:1, menuDescriptions:["\u30b2\u30fc\u30e0\u3092\u4e2d\u65ad\u3057\u3001\u30bf\u30a4\u30c8\u30eb\u753b\u9762\u306b\u623b\u308a\u307e\u3059", "\u524d\u306e\u753b\u9762\u3078\u623b\u308a\u307e\u3059"], showExit:m})
}, Hi:function(b) {
  ...
  W(this, "CONTINUE?", ["yes", "no"], this.Ii, {defaultValue:0, menuDescriptions:["\u30b7\u30b9\u30c6\u30e0\u3092\u518d\u8d77\u52d5\u3057\u3066\u51fa\u6483\u3057\u307e\u3059", "\u4f5c\u6226\u5931\u6557\u3002\u9000\u5374\u3057\u307e\u3059"], showExit:m})
}, Ii:function(b) {
  switch(b) {
    case 0:
      this.pi();
...
}, nd:k, od:0, hd:k, Ad:0, Zi:function() {
  if(1 === this.Ad) {
...
F.ue = k;
(function() {
  Fa = tm.createClass({superClass:Ma, ca:k, yg:k, nb:k, values:k, labels:k, Xd:k, xg:[u.Ah, u.Bh, u.xh, u.yh, 1], lg:k, lf:k, cursor:0, wait:0, frame:0, init:function(a, b) {
    this.superInit();
    this.ca = a;
    this.values = [this.ca.ee, this.ca.fe, ~~(100 * (this.ca.Kb / this.ca.Pd)), this.ca.jd, 0 === this.ca.kd ? u.zh : 0];
...
(function() {
  O = tm.createClass({superClass:tm.display.CanvasElement, name:k, da:k, ca:k, de:k, oa:0, cc:0, score:0, Tb:m, erase:m, star:1, zi:m, bc:j, vb:m, frame:0, he:k, direction:0, speed:0, ma:k, init:function(a, d, f) {
    this.superInit();
    this.addEventListener("added", function() {
      this.frame = 0;
      this.vb = m;
...
Ea = tm.createClass({superClass:O, zi:j, cc:0, ce:k, init:function(b, a, d) {
  this.ce = a;
...
(function() {
  ...
  O.Ih = tm.createClass({superClass:Ea, init:function(a, b) {
...
"komachi-1":[{aa:Y.zd, ba:$.Ff, x:336, y:-192}], "komachi2-0":[{aa:Y.zd, ba:$.Gf, x:144, y:-192}], "komachi2-1":[{aa:Y.zd, ba:$.Gf, x:336, y:-192}], erika:[{aa:Y.Vc, ba:$.Vc, x:240, y:-100}], yukishiro:[{aa:Y.me, ba:$.me, x:240, y:-100}], misumi:[{aa:Y.qe, ba:[$.vh, $.re, $.se], x:240, y:-100, Qb:j}], mai:[{aa:Y.pe, ba:$.pe, x:780, y:128}], hyuga:[{aa:Y.Ih, ba:[$.ve, $.we, $.xe], x:240, y:-100, Qb:j}]};
(function() {
  function b(a, b, d, f) {
